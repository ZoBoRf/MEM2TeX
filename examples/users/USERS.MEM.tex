...
pdfcreationdate={D:20200823202118},
pdftitle={TOPS-20 User's Guide},
pdfauthor={Digital Equipment Corporation},
pdfsubject={TOPS-20},
pdfkeywords={AA-FP69B-TM TOPS-20 DEC}
]{hyperref}
...
|                 and also the  document  §uline[Getting]  §uline[Started]
|                 §uline[with] §uline[TOPS-20], order number AA-4187D-TM.
...

   ...
   CHAPTER 4       FILE SPECIFICATIONS
           ...
           4.2.3     Project-Programmer Numbers - §lbrack[]PPN§rbrack[] . . . . . . . 4-4
...

   ...
   The §uline[TOPS-20] §uline[User's] §uline[Guide] describes the functions that you can  perform
|  with  the TOPS-20 operating system.  This manual is the first document
|  of two TOPS-20 user-oriented manuals.  The audience  for  the  §uline[TOPS-20]
   §uline[User's]  §uline[Guide]  ranges  from  the  entry  level  first-time user to the
...
|  from §uline[Getting] §uline[Started] §uline[with] §uline[TOPS-20] and incorporated  into  the  §uline[TOPS-20]
|  §uline[User's]  §uline[Guide].  This information is not designated with change bars in
|  the §uline[TOPS-20] §uline[User's] §uline[Guide].  Only new TOPS-20 operating system  features
|  are highlighted with change bars.

|  Once you learn about the functions described  in  the  §uline[TOPS-20]  §uline[User's]
|  §uline[Guide],  you  can  refer  to  the  second and more advanced manual, the
   §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual], for complete descriptions of all of
...

   ...
   Following is a list of manuals referenced in this manual:
         ...
         o  §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual]

         o  §uline[TOPS-20] §uline[User] §uline[Utilities] §uline[Guide]

         o  §uline[TOPS-20] §uline[Tape] §uline[Processing] §uline[Manual]

         o  §uline[TOPS-20] §uline[System] §uline[Manager's] §uline[Guide]

         o  §uline[EDIT] §uline[User's] §uline[Guide]

         o  §uline[EDIT] §uline[Reference] §uline[Manual]

         o  §uline[TV] §uline[Editor] §uline[Manual]

         o  §uline[EDT-20] §uline[Primer]

         o  §uline[TOPS-10/TOPS-20] §uline[Batch] §uline[Reference] §uline[Manual]

         o  §uline[TOPS-10/TOPS-20] §uline[DECmail/MS] §uline[Manual]


                      Conventions Used in This Manual

        §uline[Underlined] §uline[text]     indicates what  the  user  types  in  command
                            examples.
...

   ...
   §textbf[1.1]  §textbf[RECOGNIZING] §textbf[KEYBOARD] §textbf[SYMBOLS]
...

   ...
   §textbf[Table] §textbf[1-1:]  §textbf[Special] §textbf[Function] §textbf[Keys]
...

                 ...
                 If there is no escape key on your terminal, use CTRL/§lbrack[]
   ...
   §textbf[1.2]  §textbf[DIALING] §textbf[IN]
...

   ...
   §textbf[1.3]  §textbf[GETTING] §textbf[THE] §textbf[ATTENTION] §textbf[OF] §textbf[THE] §textbf[SYSTEM]
   ...
   and after a pause,
        ...
        §lbrack[]FROM OPERATOR:  SYSTEM IN OPERATION§rbrack[]
...

   ...
   §textbf[1.4]  §textbf[GETTING] §textbf[INFORMATION] §textbf[ABOUT] §textbf[YOUR] §textbf[TERMINAL]
   ...
   about your terminal.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[TERMINAL-MODE] (FOR TERMINAL)
...

   ...
   §textbf[1.5]  §textbf[DECLARING] §textbf[THE] §textbf[TERMINAL] §textbf[TYPE]
   ...
   the type of terminal you are using.
                       ...
                       _________________________________
                         ...
                         §uline[HARD] §uline[COPY]            §uline[VIDEO]
...
|                                             VT300-SERIES       
   ...
   VT100.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[VT100]
...

   ...
   then give the INFORMATION TERMINAL-MODE command.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) VT100
        @§uline[INFORMATION] (ABOUT) §uline[TERMINAL-MODE] (FOR TERMINAL)
         TERMINAL VT100
         TERMINAL SPEED 9600
         TERMINAL NO INHIBIT (NON-JOB OUTPUT)
...

   ...
   §textbf[1.5.1]  §textbf[Controlling] §textbf[Terminal] §textbf[Output]
   ...
   output to stop at the end of a page, give the following command:
        ...
        @§uline[TERMINAL] §uline[PAUSE] (ON) §uline[END-OF-PAGE]
   ...
   to stop output at the end of the page, give the following command:
        ...
        @§uline[TERMINAL] §uline[NO] §uline[PAUSE] (ON) §uline[END-OF-PAGE]
...

   ...
   TOPS-20  manuals.   The  §uline[TOPS-10/TOPS-20]  §uline[Batch]  §uline[Reference] §uline[Manual], for
   example, lists these codes.

   To specify the space bar as both the  pause  and  continue  character,
   give the following command:

        @§uline[TERMINAL] §uline[PAUSE] (ON) §uline[CHARACTER] §uline[SPACE] (AND UNPAUSE ON) §uline[SPACE]
...

   ...
   §textbf[1.5.2]  §textbf[Setting] §textbf[the] §textbf[Terminal] §textbf[Speed]
...

   ...
   baud, give the TERMINAL SPEED command:
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[SPEED] (OF INPUT) §uline[2400]
   ...
   §textbf[1.6]  §textbf[STARTING] §textbf[A] §textbf[JOB] §textbf[WITH] §textbf[LOGIN]
...

   ...
   identification  procedure  is  called  §uline[logging] §uline[in].  After you give the
   ...
   After the @ prompt, do the following:
        ...
        2.  After you see the guideword (USER), type your user  name  and
            press the ESC key.
                     ...
                     <ESC>          <ESC>
                       |              |
                 @§uline[LOGIN] (USER) §uline[SARTINI] (PASSWORD)
        ...
        3.  After you see the guideword (PASSWORD), type  your  password,
            ...
            part of your identification.
                     ...
                     <ESC>          <ESC>      <ESC>
                       |              |          |
                 @§uline[LOGIN] (USER) §uline[SARTINI] (PASSWORD) (ACCOUNT)
...

        ...
        4.  After you see the guideword (ACCOUNT), type your account and,
            ...
            similar to the one below.
                 ...
                 @§uline[LOGIN] (USER) §uline[SARTINI] (PASSWORD) (ACCOUNT) §uline[341]
...

   ...
   §textbf[1.6.1]  §textbf[User] §textbf[Names]
   ...
   §textbf[1.6.2.1]  §textbf[Selecting]  §textbf[Secure]   §textbf[Passwords] - Use   these   guidelines   in
...

   ...
   §textbf[1.6.2.2]  §textbf[Keeping]  §textbf[Your]  §textbf[Password]  §textbf[a]  §textbf[Secret] - Often   illegal   system
   ...
   Use these guidelines to prevent others from learning your password:
         ...
         o  Change your  password  frequently.   Changing  your  password
            ...
            password use the SET DIRECTORY PASSWORD command:
                 ...
                 @§uline[SET] §uline[DIRECTORY] §uline[PASSWORD] §uline[<login-directory-name>]



   §textbf[1.6.3]  §textbf[Accounts]
...

   ...
   §textbf[1.6.4]  §textbf[Session-Remark]
   ...
   §textbf[1.7]  §textbf[EXECUTING] §textbf[COMMANDS] §textbf[AUTOMATICALLY] §textbf[DURING] §textbf[LOGIN]
...

   ...
   file give the command:
        ...
        @§uline[TYPE] §uline[SYSTEM:LOGIN.CMD]

   Refer to Chapter 5 for information on how to create files.



   §textbf[1.8]  §textbf[ENDING] §textbf[A] §textbf[JOB] §textbf[WITH] §textbf[LOGOUT]
   ...
   procedure is called §uline[logging] §uline[out].
...

   ...
   §textbf[1.9]  §textbf[SETTING] §textbf[ADDITIONAL] §textbf[TERMINAL] §textbf[PARAMETERS]
   ...
   §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].  If you are reading this manual for
   the first time, you can skip these sections until later.



   §textbf[1.9.1]  §textbf[Setting] §textbf[the] §textbf[Terminal] §textbf[Page] §textbf[Length]
   ...
   To change the page length to 30, give the following command.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[LENGTH] (OF PAGE IS) §uline[30]



   §textbf[1.9.2]  §textbf[Setting] §textbf[the] §textbf[Terminal] §textbf[Line] §textbf[Width]
   ...
   50, give the following command.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[WIDTH] (OF LINE IS) §uline[50]
   ...
   §textbf[1.9.3]  §textbf[Using] §textbf[Formfeeds]
...

   ...
   appear on individual pages.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[NO] §uline[INDICATE] (FORMFEED)
...

   ...
   §textbf[2.1]  §textbf[USING] §textbf[TOPS-20] §textbf[COMMANDS]
...

   ...
   their  meanings.   The §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual] describes all
   ...
   The system prints the date in the format:
        ...
        §uline[day-of-the-week,] §uline[month] §uline[day-of-the-month,] §uline[year]
...

   ...
   filename TEST.FOR as the argument:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[TEST.FOR]
   ...
   the file TEST.FOR.3:
        ...
        @§uline[PRINT] (FILES) §uline[TEST.FOR.3/COPIES:4]
        §lbrack[]Job TEST Queued, Request-ID 41, Limit 27§rbrack[]
...

   ...
   a single subcommand to the DIRECTORY command:
        ...
        @§uline[DIRECTORY] (OF FILES),
        @@§uline[DELETED] (FILES ONLY)
        @@
   ...
   §textbf[Figure] §textbf[2-1:]  §textbf[Fields] §textbf[of] §textbf[a] §textbf[Command]
...

   ...
   §textbf[2.2]  §textbf[OBTAINING] §textbf[A] §textbf[LIST] §textbf[OF] §textbf[TOPS-20] §textbf[COMMANDS]
   ...
   print the list of TOPS-20 commands.
        ...
        @§uline[?] Command, one of the following:
...
|        TAKE          TALK           TDIRECTORY    TERMINAL    TRANSLATE
   ...
   Appendix A gives a brief description of  each  command.   The  §uline[TOPS-20]
   §uline[Commands]  §uline[Reference]  §uline[Manual]  contains  a  complete  description of all
   ...
   for you to complete the command or filename.
        ...
        @§uline[A?] Command, one of the following:
         ACCESS    ADVISE     APPEND     ARCHIVE    ASSIGN     ATTACH
          or system program name
         @A§uline[CCESS] (TO DIRECTORY) §uline[<MORRILL>]
         Password:
         @§uline[^C]
   ...
   you may type as many as you need.
        ...
        @§uline[CON?] Command, one of the following:
         CONNECT    CONTINUE
          or system program name
         @CON§uline[NECT] (TO DIRECTORY) §uline[<MORRILL>]
         Password:
         @
...

   ...
   §textbf[2.3]  §textbf[OBTAINING] §textbf[INFORMATION] §textbf[ABOUT] §textbf[THE] §textbf[PARTS] §textbf[OF] §textbf[A] §textbf[COMMAND]
   ...
   enter a valid argument.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[?] one of the following:
...
|        VT125            VT131              VT200-SERIES    VT300-SERIES
   ...
   IS):
        ...
        @§uline[TERMINAL] §uline[LENGTH] (OF PAGE IS)
   ...
   and reprints the command.
        ...
        @§uline[TERMINAL] §uline[LENGTH] (OF PAGE IS) §uline[?]  Length of page in decimal
        @TERMINAL LENGTH (OF PAGE IS)

   Choose a number (the example uses 20); type it in and press RETURN.

        @TERMINAL LENGTH (OF PAGE IS) §uline[20]
   ...
   function you requested.
        ...
        @§uline[DAYTIME] §uline[?] Confirm with carriage return
        @§uline[DAYTIME]
...

   ...
   @@, type a question mark.
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[,]
        @@§uline[?] confirm with carriage return
          or one of the following:
   ...
   mark.
        ...
        @§uline[PRINT] (FILES) §uline[/?] /SPOOLED-OUTPUT
   ...
   §textbf[2.4]  §textbf[TYPING] §textbf[COMMANDS]
...

   ...
   §textbf[2.4.1]  §textbf[Full] §textbf[Input]
   ...
   complete LOGIN command line.
        ...
        @§uline[LOGIN] §uline[SARTINI] ___ §uline[341]



   §textbf[2.4.2]  §textbf[Recognition] §textbf[Input]
...
|       1.  Prints as much of the command as the system can recognize.
   ...
   At the point where the underlining stops, press ESC.
          ...
          <ESC>        <ESC>             <ESC>
            |            |                 |
        @§uline[LOG]IN (USER) §uline[SAR]TINI (PASSWORD)___(ACCOUNT) §uline[341]
...

   ...
   RMINAL-MODE (FOR TERMINAL).  Press RETURN to end the command.
           ...
           <ESC>            <ESC>
             |                |
        @§uline[INFO]RMATION (ABOUT) §uline[T?] one of the following:
         TAPE-PARAMETERS  TERMINAL-MODE

                             <ESC>
                               |
        @INFORMATION (ABOUT) T§uline[E]RMINAL-MODE (FOR TERMINAL)
   ...
   §textbf[2.4.3]  §textbf[Abbreviated] §textbf[Input]
...

   ...
   press RETURN.
        ...
        @§uline[LOG] §uline[SARTINI] §textbf[§uline[___]] §uline[341]
   ...
   §textbf[Table] §textbf[2-1:]  §textbf[Special] §textbf[Command] §textbf[Abbreviations]
...

   ...
   terminal parameters, just type E to complete the abbreviation TE.
        ...
        @§uline[INFORMATION] §uline[T?] one of the following:
         TAPE-PARAMETERS  TERMINAL-MODE

        @INFORMATION (ABOUT) T§uline[E]
   ...
   §textbf[2.4.4]  §textbf[Combined] §textbf[Recognition] §textbf[and] §textbf[Abbreviated] §textbf[Input]
   ...
   command using the combination of input methods.
        ...
        @§uline[LOG] §uline[SARTINI] (ACCOUNT) §uline[341]
...

   ...
   §textbf[2.4.5]  §textbf[What] §textbf[Are] §textbf[Defaults]

   A §textbf[default] is the value supplied by the operating system  when  you  do
   ...
   each command's description in the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].



   §textbf[2.5]  §textbf[CONTINUING] §textbf[COMMANDS]
   ...
   split between two lines:
        ...
        @§uline[PRINT] (FILES) §uline[CONCERNS.TXT.1,] §uline[DESIGN-REVIEWS.MEM.1,] §uline[MANUFACT]
        §uline[URING.PLAN.1] §uline[/AFTER:18:00]
   ...
   and press RETURN.  Then, continue typing the command on the next line.
        ...
        @§uline[PRINT] (FILES) §uline[CONCERNS.TXT.1,] §uline[DESIGN-REVIEWS.MEM.1,] §uline[-]
        §uline[MANUFACTURING.PLAN.1] §uline[/AFTER:18:00]
   ...
   §textbf[2.6]  §textbf[ADDING] §textbf[COMMENTS] §textbf[TO] §textbf[COMMAND] §textbf[LINES]
...

   ...
   TERMINAL command:
        ...
        @§uline[TERMINAL] §uline[VT100]  §uline[;This] §uline[comment] §uline[follows] §uline[the] §uline[command]

        @§uline[!This] §uline[comment] §uline[precedes] §uline[the] §uline[command!] §uline[TERMINAL] §uline[VT100]

        @§uline[TERMINAL] §uline[!This] §uline[comment] §uline[is] §uline[within] §uline[the] §uline[command!]  §uline[VT100]

        @§uline[;This] §uline[entire] §uline[line] §uline[is] §uline[a] §uline[comment]
   ...
   §textbf[2.7]  §textbf[CORRECTING] §textbf[INPUT] §textbf[ERRORS]
   ...
   This allows you to try  again.   If  you  typed  a  §uline[valid]  command  by
...

   ...
   §textbf[2.7.1]  §textbf[DELETE] §textbf[-] §textbf[Erasing] §textbf[a] §textbf[Character]

   The DELETE key moves the cursor back one character  and  deletes  that
   character.    Most  video  terminals  actually  move  the  §textbf[cursor]  (an
   ...
   §textbf[2.7.2]  §textbf[CTRL/U] §textbf[-] §textbf[Erasing] §textbf[an] §textbf[Entire] §textbf[Line]
   ...
   §textbf[2.7.3]  §textbf[CTRL/W] §textbf[-] §textbf[Erasing] §textbf[a] §textbf[Word]
   ...
   §textbf[2.7.4]  §textbf[CTRL/R] §textbf[-] §textbf[Reprinting] §textbf[a] §textbf[Command] §textbf[Line]
   ...
   command more readable by incorporating the correction, type CTRL/R.
        ...
        @§uline[TERMINAL] (FEATURE OR TYPE) §uline[WIDHT]\T\H§uline[TH^R]
        @TERMINAL (FEATURE OR TYPE) WIDTH



   §textbf[2.7.5]  §textbf[CTRL/H] §textbf[-] §textbf[Reprinting] §textbf[Part] §textbf[of] §textbf[an] §textbf[Erroneous] §textbf[Command] §textbf[Line]
...

   ...
   the TERMINAL command:
        ...
        @§uline[TERM]INAL (FEATURE OR TYPE) §uline[LENGTH-WIDTH]
        ?Does not match switch or keyword - "LENGTH-WIDTH"
        @§uline[^H]
        @TERMINAL (FEATURE OR TYPE) §uline[LENGTH] §uline[66]
   ...
   §textbf[2.8]  §textbf[SETTING] §textbf[ALERTS]
   ...
   ALERT command.
        ...
        @§uline[SET] §uline[ALERT] (AT TIME) §uline[9:45:00] (MESSAGE) §uline[PREPARE] §uline[FOR] §uline[10:00] §uline[MEETING]

        §lbrack[]09:45:00 alert - PREPARE FOR 10:00 MEETING§rbrack[]
   ...
   current time:
        ...
        @§uline[SET] §uline[ALERT] (AT TIME) §uline[+00:10:00] (MESSAGE) §uline[END] §uline[OF] §uline[COFFEE] §uline[BREAK!]

        §lbrack[]10:02:26 alert - END OF COFFEE BREAK!§rbrack[]
   ...
   Section 1.7.  Refer to  the  §uline[TOPS-20]  §uline[Commands]  §uline[Reference]  §uline[Manual]  for
   ...
   INFORMATION ALERTS command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[ALERTS] (PENDING)
...

   ...
   §textbf[2.9]  §textbf[OPERATING] §textbf[SYSTEM] §textbf[STOPPAGE]
   ...
   prints:
        ...
        §lbrack[]DECSYSTEM-20 continued§rbrack[]
   ...
   following:
        ...
        §lbrack[]From OPERATOR on line 6:   SYSTEM IN OPERATION§rbrack[]
...

   ...
   §textbf[3.1]  §textbf[GETTING] §textbf[A] §textbf[LIST] §textbf[OF] §textbf[USERS] §textbf[ON] §textbf[THE] §textbf[SYSTEM]
...
|  
|       @§uline[SYSTAT] §uline[NODE] §uline[KL2102]
...

   ...
   §textbf[3.2]  §textbf[LINKING] §textbf[WITH] §textbf[OTHER] §textbf[TERMINALS]
   ...
   press RETURN, the system prints the message ?UNRECOGNIZED COMMAND.
        ...
        LINK FROM SARTINI, TTY26
        @§uline[!] §uline[This] §uline[is] §uline[a] §uline[test.]
   ...
   the system prints the @ sign on the next line.
        ...
        §uline[PER] §uline[YOUR] §uline[REQUEST,] §uline[A] §uline[NEW] §uline[COPY] §uline[OF] §uline[THE]
        §uline[UPDATED] §uline[LIST] §uline[OF] §uline[MANUALS] §uline[IS] §uline[AVAILABLE]
        §uline[IN] §uline[THE] §uline[DIRECTORY] §uline[<NEW-MANUALS>.] §uline[^Z]
...

   ...
   also give the BREAK command to end the link with your terminal.
        ...
        @§uline[!SEND] §uline[MAIL] §uline[TO] §uline[HOLLAND] §uline[WITH] §uline[THE] §uline[INFO.]
        @§uline[BREAK] (LINKS)
   ...
   §textbf[3.3]  §textbf[READING] §textbf[MAIL]
...

   ...
   §textbf[3.3.1]  §textbf[System] §textbf[Mail]
   ...
   terminal when you log in.
        ...
        @§uline[LOGIN] (USER) §uline[SARTINI] (PASSWORD)___ (ACCOUNT) §uline[341]
   ...
   with the message:
        ...
        §lbrack[]New message-of-the day available§rbrack[]

   To read the new message of the day, use the  INFORMATION  MAIL  SYSTEM
   command:

        @§uline[INFORMATION] §uline[MAIL] §uline[SYSTEM]
        Sender: OPERATOR
   ...
   §textbf[3.3.2]  §textbf[User] §textbf[Mail]
...
|  
|       §lbrack[]You have netmail from COMBS@GIDNEY at 14:40:56§rbrack[]
...
|  program, refer to the §uline[TOPS-10/TOPS-20] §uline[DECmail/MS] §uline[Manual]).
|  
...
|  NEW command:
|  
|       MS>§uline[READ] (MESSAGE SEQUENCE) §uline[NEW]
...
|  
|       MS>§uline[READ] (MESSAGE SEQUENCE) message sequence
|  
|       or
|  
|       MS READ>>§uline[READ]
...

   ...
   §textbf[3.4]  §textbf[SENDING] §textbf[MAIL]
...
|  
|       MS>§uline[SEND]
|       To: §uline[PORADA,] §uline[MORRILL,] §uline[MCELMOYLE]
|       cc: §uline[BROPHY]
|       Subject: §uline[SYSTEM] §uline[CHANGES]
|  
...
|  
|       §uline[THERE] §uline[IS] §uline[A] §uline[LIST] §uline[OF] §uline[THE] §uline[NEW] §uline[SYSTEM]
|       §uline[CHANGES] §uline[AVAILABLE] §uline[IN] §uline[THE] §uline[PROJECT]
|       §uline[ROOM.]
|       §uline[^Z]
|  
...
|  §uline[TOPS-10/TOPS-20] §uline[DECmail/MS] §uline[Manual].



   §textbf[3.5]  §textbf[SENDING] §textbf[QUICK] §textbf[MESSAGES]
   ...
   command:
        ...
        @§uline[SYSTAT] §uline[KISTLER]
          10    11  EXEC     KISTLER
        @§uline[SEND] §uline[KISTLER] §uline[Are] §uline[you] §uline[on] §uline[the] §uline[North] §uline[project] §uline[interest] §uline[list?]
   ...
   formatted on the receiver's terminal.
        ...
        @§uline[SEND] §uline[KISTLER] §uline[The] §uline[North] §uline[project] §uline[team] §uline[meets] §uline[every] §uline[Friday] §uline[at] §uline[9] §uline[in] 
        §uline[the] §uline[Lunar] §uline[Conference] §uline[Room.]

   The message appears on the receiver's terminal as:

        From LEOPOLD on line 11:
        §lbrack[]The North project team meets every Friday at 9 in the Lunar
         Conference Room.§rbrack[]
...
|  
|       @§uline[SEND] §uline[/NODE:THUP] §uline[ANDERSON] §uline[Don't] §uline[forget] §uline[the] §uline[meeting!]



   §textbf[3.6]  §textbf[COMMUNICATING] §textbf[WITH] §textbf[THE] §textbf[OPERATOR]
   ...
   operator is finished, press ESC.
        ...
        §uline[What] §uline[happened] §uline[to] §uline[the] §uline[RP07?]<CTRL/Z>
        §lbrack[]PLSOPN Operator at GIDNEY has been notified at 11:18:32§rbrack[]
   ...
   press ESC after your message:
        ...
        Enter text, terminate with CTRL/Z to wait for response,
        or ESCape to send message and exit
        §uline[The] §uline[laser] §uline[printer] §uline[is] §uline[out] §uline[of] §uline[paper]<ESC>
        §lbrack[]PLSOPN Operator at GIDNEY has been notified at 11:18:32§rbrack[]
        @
...

   ...
   For a complete description of the PLEASE program, refer to the §uline[TOPS-20]
   §uline[User] §uline[Utilities] §uline[Guide].



   §textbf[3.7]  §textbf[CONTROLLING] §textbf[MESSAGES] §textbf[AND] §textbf[TERMINAL] §textbf[LINKS]
   ...
   §textbf[3.7.1]  §textbf[System] §textbf[Messages]
   ...
   user.  Some examples of system messages are:
        ...
        §lbrack[]Caution -- disk space is low§rbrack[]
        §lbrack[]System going down in 1 minute!§rbrack[]
        §lbrack[]Deleted files will be expunged in 30 seconds§rbrack[]
        §lbrack[]System expunge completed§rbrack[]
   ...
   SYSTEM-MESSAGES command to suppress system messages.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[TERMINAL-MODE]
            .
            .
         REFUSE LINKS
         REFUSE ADVICE
   ...
   the RECEIVE USER-MESSAGES command to accept user messages.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[TERMINAL-MODE]
         ...
         REFUSE USER-MESSAGES
            ...
            .
         TERMINAL FULLDUPLEX
        @§uline[RECEIVE] §uline[USER-MESSAGES]



   §textbf[3.7.3]  §textbf[Terminal] §textbf[Links]
...

   ...
   §textbf[3.7.4]  §textbf[Inhibiting] §textbf[All] §textbf[Non-Job] §textbf[Output]
...

   ...
   §textbf[3.7.5]  §textbf[Mail] §textbf[Messages]
   ...
   mail arrives:
        ...
        §lbrack[]You have a message from PRATT§rbrack[]
   ...
   MAIL-WATCH command.
        ...
        §lbrack[]You have mail from PRATT at 16:07:05§rbrack[]
...

   ...
   last unread message in your MAIL file.
        ...
        @§uline[INFORMATION] §uline[MAIL]
         Mail from PRATT at 16:07:05



   §textbf[3.7.6]  §textbf[Alerts]

   An alert results from your giving a SET ALERT command:

        §lbrack[]08:55:00 alert - Group meeting in 5 minutes§rbrack[]
   ...
   This command cancels alerts for the next hour:
        ...
        @§uline[SET] §uline[NO] §uline[ALERT] §uline[+01:00]
...

   ...
   §textbf[4.1]  §textbf[TOPS-20] §textbf[FILE] §textbf[SYSTEM] §textbf[ORGANIZATION]
   ...
   §textbf[4.2]  §textbf[COMPLETE] §textbf[FORM] §textbf[OF] §textbf[A] §textbf[FILE] §textbf[SPECIFICATION]
...

   ...
   where:
        ...
        <dir>          is a  directory  name,  or  in  special  cases,  a
                       ...
                       in angle brackets <> or square brackets §lbrack[]§rbrack[].
   ...
   §textbf[4.2.1]  §textbf[Device] §textbf[Names] §textbf[-] §textbf[dev:]
...

   ...
   §textbf[Table] §textbf[4-1:]  §textbf[System] §textbf[Device] §textbf[Names]
   ...
   *  For example, COPY (FROM) NUL: (TO) TEST.FIL erases the contents 
   ...
   colon  following  the  device  name is optional.  Refer to the §uline[TOPS-20]
   §uline[Command] §uline[Reference] §uline[Manual].
   ...
   §textbf[4.2.2]  §textbf[Directory] §textbf[Names] §textbf[-] §textbf[<DIR>]
   ...
   brackets  §lbrack[]§rbrack[].   Therefore,  if  your user name is KIRSCHEN, you have a
...

   ...
   §textbf[4.2.3]  §textbf[Project-Programmer] §textbf[Numbers] §textbf[-] §textbf[§lbrack[]PPN§rbrack[]]
   ...
   §textbf[Table] §textbf[4-2:]  §textbf[Special] §textbf[System] §textbf[Programs]
...

   ...
   project-programmer number associated with the directory <KIRSCHEN>:
        ...
        @§uline[TRANSLATE] (DIRECTORY) §uline[<KIRSCHEN>]
        PS:<KIRSCHEN> (IS) PS:§lbrack[]4,516§rbrack[]
   ...
   following commands:
        ...
        *TTY:=PLEASE.MAC§lbrack[]4,516§rbrack[],PLEASE.MAC/A

   Refer to the §uline[TOPS-20] §uline[User] §uline[Utilities] §uline[Guide] for a  complete  description
   of the FILCOM program.



   §textbf[4.2.4]  §textbf[Filenames] §textbf[-] §textbf[name]
...

   ...
   §textbf[4.2.5]  §textbf[File] §textbf[Types] §textbf[-] §textbf[.typ]
   ...
   §textbf[4.2.6]  §textbf[Generation] §textbf[Numbers] §textbf[-] §textbf[.gen]
...

   ...
   §uline[TOPS-20]  §uline[User] §uline[Utilities] §uline[Guide] for a description of the DUMPER program,
   ...
   §textbf[Table] §textbf[4-3:]  §textbf[Symbolic] §textbf[Generation] §textbf[Numbers]
...

   ...
   §textbf[4.2.7]  §textbf[File] §textbf[Attributes] §textbf[-] §textbf[;A,] §textbf[;P,] §textbf[;T]
...

   ...
   account of 17:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[*.*;A17]

                                    NOTE

           You can specify other file attributes when working  in
           a  DECnet  or  magnetic  tape  environment.   Refer to
           Appendix C of the §uline[TOPS-20]  §uline[Commands]  §uline[Reference]  §uline[Manual]
           for  the  complete  list of attributes.  The §uline[DECnet-20]
           §uline[User's] §uline[Guide] further describes the DECnet-related file
           attributes.



   §textbf[4.3]  §textbf[USING] §textbf[WILDCARDS] §textbf[TO] §textbf[SPECIFY] §textbf[FILES]
   ...
   in the directory <SMITH> with the file type .TXT:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[*.TXT]
   ...
   filenames beginning with the letter L.
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[L*]
...

   ...
   filenames ending with the letter T.
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[*T]
   ...
   beginning with the letter L and ending with the letters ST:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[L%ST]
   ...
   §textbf[4.4]  §textbf[SPECIFYING] §textbf[SPECIAL] §textbf[CHARACTERS] §textbf[-] §textbf[CTRL/V]
...

   ...
   §textbf[4.5]  §textbf[TYPING] §textbf[FILE] §textbf[SPECIFICATIONS]
...
|            2
   ...
   type, .PAS.
                          ...
                          <ESC>         <CTRL/F>
                            |             |    
        @§uline[RENAME] (FILE) §uline[PROG1].OAS.* (TO BE) PROG1.§uline[PAS]
...

   ...
   press ESC.  The system prints .3 (the highest generation number).
                           ...
                           <ESC>
                             |
        @§uline[TYPE] (FILE) §uline[TEST.TXT].3
   ...
   destination file becomes TEST.TXT.4.
                          ...
                          <ESC>           <ESC>
                            |               |            
        @§uline[COPY] (FROM) §uline[NEW.FIL].1 (TO) §uline[TEST.TXT].4 !New generation!
   ...
   command.
        ...
        @§uline[PRINT] (FILES) §uline[ATEST.LOG,] §uline[BTEST.LOG,] §uline[CTEST.LOG]
        §lbrack[]Printer job ATEST queued, request #18, limit 9, 3 files§rbrack[]
...

   ...
   §textbf[4.6]  §textbf[USING] §textbf[LOGICAL] §textbf[NAMES]
   ...
   directory names.
        ...
        @§uline[DEFINE] (LOGICAL NAME) §uline[ALL:] (AS) §uline[PS:<KONEN>,PS:<TEAM>]
   ...
   directory, give the following command:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[ALL:TEST.FOR]
...

   ...
   INFORMATION LOGICAL-NAMES JOB command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[LOGICAL-NAMES] (OF) §uline[JOB]
   ...
   SYSTEM command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[LOGICAL-NAMES] (OF) §uline[SYSTEM]
   ...
   <KONEN>.
        ...
        @§uline[DEFINE] (LOGICAL-NAME) §uline[TEST:] §uline[SYS:,PS:<TEAM>,PS:<KONEN>]
   ...
   area defined in ALL:.
        ...
        @§uline[COPY] (FILE) §uline[CHECK.TST.1] (TO) §uline[ALL:CHECK.TST.1] !New file!
         CHECK.TST.1 => <KONEN>CHECK.TST.1 §lbrack[]OK§rbrack[]
...

   ...
   logical name TEST::
        ...
        @§uline[DEFINE] (LOGICAL-NAME) §uline[TEST:]
   ...
   name, and then giving the DIRECTORY command using the logical name:
        ...
        @§uline[DEFINE] (LOGICAL NAME) §uline[TS:] (AS) §uline[PS:<TEST-SPECS>]
        @§uline[DIRECTORY] (OF FILES) §uline[TS:]
   ...
   the file.
        ...
        @§uline[DEFINE] (LOGICAL NAME) §uline[PP:](AS) §uline[R4-PROJECT-PLAN.RNO]
        @§uline[EDIT] §uline[PP:]
   ...
   §textbf[4.6.1]  §textbf[The] §textbf[Device] §textbf[DSK:]
   ...
   of the logical name DSK:.  The following type of definition:
        ...
        @§uline[DEFINE] (LOGICAL NAME) §uline[DSK:] (AS) §uline[DSK:,ADMIN:<TESTER>]
...

   ...
   Another example is:
        ...
        @§uline[DEFINE] (LOGICAL NAME) §uline[DSK:] (AS) §uline[DSK:,ADMIN:<RECORD>,] -
        §uline[ADMIN:<GENLED>]
   ...
   §textbf[4.6.2]  §textbf[The] §textbf[Device] §textbf[POBOX:]
...
|  search  list  that  points to structures where your mail files reside.
   ...
   LOGICAL-NAMES POBOX:.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[LOGICAL-NAMES] (OF) §uline[POBOX:]
        System-wide:
...

   ...
   §textbf[5.1]  §textbf[SELECTING] §textbf[AN] §textbf[EDITOR]
   ...
   Your Own Programs, and use the FORTRAN program for the examples).
        ...
        3.  Press the RETURN key.  EDIT prints the name of the input file
            and the first line number.
                      ...
                      <ESC>
                        |
                 @§uline[CREATE] (FILE) §uline[SQRT.ALG]<RET>
                 Input:  SQRT.ALG.1
                 00100
        ...
        4.  Begin typing your program.  (If you make a mistake, refer  to
            ...
            want to edit your file.  (See Section C.2.1 in Appendix C).
                 ...
                 00100   BEGIN<RET>
                 00200   REAL X,Y;<RET>
                 00300   WRITE ("§lbrack[]2C§rbrack[] TYPE THE VALUE OF X: §lbrack[]B§rbrack[]");<RET>
                 00400   <TAB>  READ (X);<RET>
                 00500   <TAB>  Y :=SQRT(X);<RET>
                 00600   WRITE ("§lbrack[]C§rbrack[] THE SQUAREROOT OF ");<RET>
...

        ...
        6.  Type E (for End) and press the RETURN key.  EDIT  prints  the
            ...
            TOPS-20 operating system.
                 ...
                 *§uline[E]<RET>
                 ...
                 §lbrack[]SQRT.ALG.1§rbrack[]
                 @

   EDIT is fully  described  in  the  §uline[EDIT]  §uline[User's]  §uline[Guide]  and  the  §uline[EDIT]
   §uline[Reference] §uline[Manual].



   §textbf[5.1.2]  §textbf[TV]
   ...
   is  described  in  the §uline[TV] §uline[Editor] §uline[Manual].  .hl2 EDT-20 EDT is DIGITAL's
...

   ...
   To learn how to use EDT on TOPS-20, refer to the §uline[EDT-20] §uline[Primer].  For a
   complete  description  of  EDT-20 commands and functions, refer to the
   §uline[EDT-20] §uline[Reference] §uline[Manual].  Once you have begun using EDT, the §uline[EDT] §uline[Quick]
   §uline[Reference] §uline[Guide] is a summary of EDT commands and functions.



   §textbf[5.2]  §textbf[DEFINING] §textbf[THE] §textbf[LOGICAL] §textbf[NAME] §textbf[EDITOR]
   ...
   definition of EDITOR:  give the INFORMATION LOGICAL-NAMES command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[LOGICAL-NAMES] (OF) §uline[EDITOR:]
        System-wide:
   ...
   to use, make your own definition of EDITOR:  with the DEFINE command:
        ...
        @§uline[DEFINE] (LOGICAL NAME) §uline[EDITOR:]  (AS) §uline[SYS:EDT.EXE]
   ...
   §textbf[5.3]  §textbf[CORRECTING] §textbf[TYPING] §textbf[ERRORS]
         ...
         o  The DELETE Key -  Use  the  DELETE  key  to  erase  incorrect
            ...
            for each deleted character.
                  ...
                  character.) You can then continue typing the line.
                       ...
                       00600   WRITE ("§lbrack[]C§rbrack[] THE OFF\O\ T\O\OEROOT OF ")
...

   ...
   §textbf[6.1]  §textbf[USING] §textbf[FILE] §textbf[STRUCTURES]
...
|  remains on  line  during  system  operation.   This  public  structure
   ...
   key.
        ...
        @§uline[DIRECTORY]<RET>     Request a list of your filenames.
...
|  structure  (BS:)  remains  on  line  during  system  operation,  other
   ...
   "unregulated.")
        ...
        @§uline[MOUNT] §uline[STRUCTURE] (NAME) §uline[MISC:]
   ...
   structure.
        ...
        @§uline[DISMOUNT] §uline[STRUCTURE] (NAME) §uline[MISC:]
   ...
   INFORMATION STRUCTURE * command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[STRUCTURE] (NAME) §uline[*]
...

   ...
   §textbf[6.2]  §textbf[PROTECTING] §textbf[DIRECTORIES] §textbf[AND] §textbf[FILES]
   ...
   description of groups, refer to the §uline[TOPS-20] §uline[System] §uline[Managers] §uline[Guide].)
   ...
   §textbf[6.2.1]  §textbf[Directory] §textbf[Protection] §textbf[Numbers]
...

   ...
   §textbf[Table] §textbf[6-1:]  §textbf[Directory] §textbf[Protection] §textbf[Digits]
   ...
   §textbf[6.2.2]  §textbf[File] §textbf[Protection] §textbf[Numbers]
...

   ...
   §textbf[Table] §textbf[6-2:]  §textbf[File] §textbf[Protection] §textbf[Digits]
   ...
   §textbf[6.2.3]  §textbf[Checking] §textbf[Protection] §textbf[Numbers]
...

   ...
   system prints an error message and cancels the command.
        ...
        @§uline[TYPE] (FILE) §uline[<HOLLAND>TEST.TXT]
   ...
   command with the PROTECTION subcommand).
        ...
        @§uline[VDIRECTORY] (OF FILES) §uline[TEST.FIL]
           PS:<PORADA>
...

   ...
   §textbf[6.2.4]  §textbf[Changing] §textbf[a] §textbf[Directory] §textbf[Protection] §textbf[Number]

   To change  a  directory  protection  number,  use  the  SET  DIRECTORY
   PROTECTION command.

        @§uline[SET] §uline[DIRECTORY] §uline[PROTECTION] (OF DIRECTORY) §uline[<EMORRILL>] (TO) §uline[770000]



   §textbf[6.2.5]  §textbf[Changing] §textbf[a] §textbf[File] §textbf[Protection] §textbf[Number]
   ...
   DIRECTORY FILE-PROTECTION-DEFAULT command.
        ...
        @§uline[SET] §uline[DIRECTORY] §uline[FILE-PROTECTION-DEFAULT] §uline[<BLACK>] §uline[770000]

   To change a file  protection  number,  use  the  SET  FILE  PROTECTION
   command.

        @§uline[SET] §uline[FILE] §uline[PROTECTION] (OF FILES) §uline[TEST.FIL] (TO) §uline[774400]
   ...
   §textbf[6.3]  §textbf[CONNECTING] §textbf[TO] §textbf[DIRECTORIES]
   ...
   structure:
        ...
        @§uline[LOGIN] (USER) §uline[MCELMOYLE] (PASSWORD)___(ACCOUNT) §uline[341]
...

   ...
   the public structure.
        ...
        @§uline[CONNECT] (TO DIRECTORY) §uline[<BROWN>]
        Password:___
                         _____PS:_____
                         |           |
                         |           |
...

   ...
   the directory <BROPHY> on the structure MISC:.
        ...
        @§uline[CONNECT] (TO DIRECTORY) §uline[MISC:<BROPHY>]
        Password:___
   ...
   then you are connected to your logged in directory.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[JOB-STATUS]
         Host AURORA
...

   ...
   §textbf[6.4]  §textbf[ACCESSING] §textbf[DIRECTORIES]
   ...
   <BROWN>.
        ...
        @§uline[ACCESS] (TO DIRECTORY) §uline[<BROWN>]
        Password:___
...

   ...
   example:
        ...
        @§uline[ACCESS] (TO DIRECTORY) §uline[<BROWN>]
        Password:___
        @§uline[ACCESS] (TO DIRECTORY) §uline[MISC:<BROPHY>]
        Password:___
...

   ...
   §textbf[6.5]  §textbf[COPYING] §textbf[FILES]
   ...
   destination file 2TEST.DAT.
        ...
        @§uline[COPY] (FROM) §uline[TEST1.DAT.1] (TO) §uline[2TEST.DAT].2 !New generation!
         TEST1.DAT.1 => 2TEST.DAT.2 §lbrack[]OK§rbrack[]
   ...
   file keeps the same name.
        ...
        @§uline[ACCESS]<ESC>(TO DIRECTORY) §uline[<PORADA>]<RET>
        Password: <RET>

        @§uline[COPY]<ESC>(FROM) §uline[<PORADA>TODAY.EXE]<ESC>.3 (TO)<RET>
         <PORADA>TODAY.EXE.3  => TODAY.EXE.1 §lbrack[]OK§rbrack[]
   ...
   above.  The system prints the generation number and guideword (TO):
        ...
        @§uline[COPY]<ESC>(FROM) §uline[<PORADA>TODAY.EXE]<ESC>.3 (TO)
   ...
   you that it has copied the file.
        ...
        @§uline[COPY]<ESC>(FROM) §uline[<PORADA>TODAY.EXE]<ESC>.3 (TO) §uline[TEST.EXE]<RET>
         <PORADA>TODAY.EXE.3  => TODAY.EXE.1 §lbrack[]OK§rbrack[]
        @
...

   ...
   file.
        ...
        @§uline[COPY] (FROM) §uline[TEST.*] (TO) §uline[NEWTST].*.-1
         TEST.FOR.1 => NEWTST.FOR.1 §lbrack[]OK§rbrack[]
         TEST.TXT.2 => NEWTST.TXT.1 §lbrack[]OK§rbrack[]
   ...
   §textbf[6.6]  §textbf[RENAMING] §textbf[FILES]
   ...
   actually duplicating the file.
        ...
        @§uline[RENAME] (EXISTING FILE) §uline[TEST1.DAT.*] (TO BE) §uline[TESTAL.DAT.-1]
         TEST1.DAT.1 => TESTAL.DAT.2 §lbrack[]OK§rbrack[]
   ...
   can delete the original.
        ...
        @§uline[COPY] (FROM) §uline[MISC:TEST.FIL.5] (TO) §uline[TEST.FIL.1] !New file!
         MISC:TEST.FIL.5 => TEST.FIL.1 §lbrack[]OK§rbrack[]
        @§uline[DELETE] §uline[MISC:TEST.FIL.5]



   §textbf[6.7]  §textbf[APPENDING] §textbf[FILES]
   ...
   CHECK.TXT:
        ...
        @§uline[APPEND] (SOURCE FILE) §uline[STAT.TXT.5] (TO) §uline[CHECK.TXT]
         STAT.TXT.5 §lbrack[]OK§rbrack[]
...

   ...
   alphabetical order when using a wildcard for the filename.
        ...
        @§uline[APPEND] (SOURCE FILE) §uline[*.FOR] (TO) §uline[ATEST.FOR.1] !New file!
         ACCOUN.FOR.2 §lbrack[]OK§rbrack[]
         ACCTST.FOR.1 §lbrack[]OK§rbrack[]
         NEWTST.FOR.1 §lbrack[]OK§rbrack[]
         TEST.FOR.1 §lbrack[]OK§rbrack[]
   ...
   message §lbrack[]OK§rbrack[] when the file has been appended.

        @§uline[APPEND] (SOURCE FILE) §uline[PS:<DOE>SMALL.FOR] (TO) §uline[MISC:<DOE>LARGE.FOR]
           PS:<LATTA>SMALL.FOR.2 §lbrack[]OK§rbrack[]
   ...
   §textbf[6.8]  §textbf[LISTING] §textbf[FILES]
   ...
   To see a copy of ADDTWO.FOR type the following command:
        ...
        @§uline[TYPE] (FILE) §uline[ADDTWO.FOR]
   ...
   §textbf[6.9]  §textbf[PRINTING] §textbf[FILES]

   To print a file or files, give the PRINT command.  The  PRINT  command
   places entries into the line printer output queue.

        @§uline[PRINT] (FILES) §uline[UPDATE.CBL]
        §lbrack[]Printer job UPDATE queued, request  57, limit 27§rbrack[]
...

   ...
   /USER switch.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[OUTPUT-REQUESTS]
   ...
   switches.
        ...
        @§uline[PRINT] §uline[?]  /SPOOLED-OUTPUT
          or Job switch, one of the following:
...
|        or File specification
   ...
   you specify.
        ...
        @§uline[PRINT] (FILES) §uline[LARGE.DAT,] §uline[MYTEST.DAT,] §uline[TEST1.DAT] §uline[/AFTER:15-MAR-88]
        §lbrack[]Printer job LARGE queued, request #58, limit 27§rbrack[]
...

   ...
   the system prints six copies of the first file only.
        ...
        @§uline[PRINT] (FILES) §uline[LARGE.DAT/COPIES:6,] §uline[MYTEST.DAT,] §uline[TEST1.DAT]
   ...
   copies of each of the three files.
        ...
        @§uline[PRINT] (FILES)§uline[/COPIES:6,LARGE.DAT,MYTEST.DAT,TEST1.DAT]
...
|       §lbrack[]Printer job FILE4 queued, request #33, limit 1 files§rbrack[]
|  
...
|  
|       @§uline[PRINT] §uline[FILE.DAT/REMOTE-PRINTER:XEROX/DESTINATION-NODE:LAT97]
...
|  
|       @§uline[PRINT] §uline[MYFILE.MEM/REMOTE-PRINTER:XEROX]
|       @
|  
|  For  more  information  about  directing  print  requests  to   remote
|  destinations, refer to the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].



   §textbf[6.9.1]  §textbf[Modifying] §textbf[a] §textbf[PRINT] §textbf[Request]
   ...
   LARGE.DAT by including the /AFTER:  switch:
        ...
        @§uline[MODIFY] (REQUEST TYPE) §uline[PRINT] (ID) §uline[LARGE] §uline[/AFTER:25-MAR-88]
   ...
   message §lbrack[]No Jobs modified§rbrack[].



   §textbf[6.9.2]  §textbf[Canceling] §textbf[a] §textbf[PRINT] §textbf[Request]
   ...
   queue,  the system prints the message §lbrack[]1 Job Canceled§rbrack[].  If the system
   is processing the entry when you give the CANCEL command, it stops the
   job and prints the message, §lbrack[]1 Job Canceled (1 was in progress)§rbrack[].

   The following example shows  how  to  cancel  the  PRINT  request  for
   TEST.FOR.

        @§uline[CANCEL] (REQUEST TYPE) §uline[PRINT] (ID) §uline[TEST]
...

   ...
   can cancel them all by using an asterisk.
        ...
        @§uline[CANCEL] (REQUEST TYPE) §uline[PRINT] (ID) §uline[*]
...
|  
|       @§uline[CANCEL] §uline[PRINT] §uline[SUM7/DESTINATION-NODE:KL2102]
|       §lbrack[]1 print request cancelled§rbrack[]
|  
...
|  node.
   ...
   §textbf[6.9.3]  §textbf[Setting] §textbf[Defaults] §textbf[for] §textbf[the] §textbf[PRINT] §textbf[Command]
   ...
   command in COMAND.CMD.
        ...
        @§uline[SET] §uline[DEFAULT] (FOR) §uline[PRINT] §uline[/NOTE:FLOOR4]
   ...
   INFORMATION DEFAULTS PRINT command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[DEFAULTS] (FOR) §uline[PRINT]
...

   ...
   §textbf[6.10]  §textbf[DELETING] §textbf[AND] §textbf[RESTORING] §textbf[FILES]
   ...
   command:
        ...
        @§uline[DELETE] (FILES) §uline[TEST.FIL]
         TEST.FIL.5 §lbrack[]OK§rbrack[]
   ...
   all the files that have been deleted but not yet expunged.
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[TEST.FIL.5,]
        @@§uline[DELETED]
        @@
   ...
   To restore TEST.FIL, give the UNDELETE command.
        ...
        @§uline[UNDELETE] (FILES) §uline[TEST.FIL.5]
         TEST.FIL.5 §lbrack[]OK§rbrack[]
...

   ...
   immediately.
        ...
        @§uline[DELETE] (FILES) §uline[TEST.FIL]
         TEST.FIL.5 §lbrack[]OK§rbrack[]
        @§uline[EXPUNGE] (DELETED FILES)
           PS:<PORADA> §lbrack[]3 pages freed§rbrack[]
   ...
   §textbf[6.11]  §textbf[CREATING] §textbf[TEMPORARY] §textbf[FILES]
   ...
   your input with a CTRL/Z:
        ...
        @§uline[COPY] (FROM) §uline[TTY:]  (TO) §uline[TEMP.FIL;T]
         TTY:  => TEMP.FIL.100160;T

        §uline[ESCAPE] §uline[031]
        §uline[EXTENDED]
        §uline[OPAQUE]
        §uline[PAGE]
        §uline[^Z]
   ...
   To give an existing file the ;T attribute, use the RENAME command.
        ...
        @§uline[RENAME] (EXISTING FILE) §uline[SCRATCH.FIL] (TO BE) §uline[SCRATCH.FIL;T]
         SCRATCH.FIL.1 => SCRATCH.FIL.100014;T §lbrack[]OK§rbrack[]
...

   ...
   Refer to Appendix C of the §uline[TOPS-20] §uline[Commands]  §uline[Reference]  §uline[Manual]  for  a
   complete list of file attributes.



   §textbf[6.12]  §textbf[REGULATING] §textbf[DISK] §textbf[FILE] §textbf[STORAGE]
   ...
   using, give the INFORMATION DISK-USAGE command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[DISK-USAGE] (OF DIRECTORY) §uline[<SARTINI>]
         PS:<SARTINI>
         37 Pages assigned
...

   ...
   for as long as possible.
        ...
        @§uline[SET] §uline[FILE] §uline[RESIST] (MIGRATION OF FILES) §uline[MEMO.INI]
         MEMO.INI.1 §lbrack[]OK§rbrack[]
...

   ...
   command with the RESIST-MIGRATION subcommand:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[,]
        @@§uline[RESIST-MIGRATION] (FILES ONLY) 
        @@
   ...
   are requesting the restoration of the file from off-line storage.
        ...
        @§uline[RETRIEVE] (FILES) §uline[MYTEST.DAT.1]

         MYTEST.DAT.1 §lbrack[]OK§rbrack[]
   ...
   command.  The system prints a list of requests in the retrieval queue.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[RETRIEVAL-REQUESTS]
...

   ...
   off-line file are restored to disk by using the CANCEL command.
        ...
        @§uline[CANCEL] (REQUEST TYPE) §uline[RETRIEVE] (ID) §uline[MYTEST]
        §lbrack[]1 Job canceled§rbrack[]



   §textbf[6.13]  §textbf[LONG] §textbf[TERM] §textbf[OFF-LINE] §textbf[FILE] §textbf[STORAGE]
   ...
   description in the §uline[TOPS-20] §uline[User] §uline[Utilities] §uline[Guide] for more information.



   §textbf[6.13.1]  §textbf[Archiving] §textbf[Files]

   To mark a file for archiving, give the ARCHIVE  command,  followed  by
   the name of the file you want archived.

        @§uline[ARCHIVE] (FILES) §uline[CHECK.TXT]
         CHECK.TXT.1 §lbrack[]Requested§rbrack[]



   §textbf[6.13.2]  §textbf[Getting] §textbf[Information] §textbf[about] §textbf[Archive] §textbf[Status] §textbf[of] §textbf[Files]

   To see that the file is marked for  archiving,  give  the  INFORMATION
   ARCHIVE-STATUS command, followed by the name of the file.

        @§uline[INFORMATION] (ABOUT) §uline[ARCHIVE-STATUS] (OF FILES) §uline[CHECK.TXT]
...

   ...
   §textbf[6.13.3]  §textbf[Canceling] §textbf[an] §textbf[Archive] §textbf[Request]
   ...
   shows that archive is requested but not completed.
        ...
        @§uline[CANCEL] (REQUEST TYPE) §uline[ARCHIVE] (FOR FILES) §uline[CHECK.TXT]
         CHECK.TXT.1 §lbrack[]OK§rbrack[]



   §textbf[6.13.4]  §textbf[Retrieving] §textbf[an] §textbf[Archived] §textbf[File]
   ...
   archived file, and moves the file to your directory on disk.
        ...
        @§uline[RETRIEVE] (FILES) §uline[CHAP21.TCT]
         CHAP21.TCT.1 §lbrack[]OK§rbrack[]
...

   ...
   contents are restored to disk, by using the CANCEL RETRIEVE command.
        ...
        @§uline[CANCEL] (REQUEST TYPE) §uline[RETRIEVE] (ID) §uline[CHAP21]
        §lbrack[]1 Job Canceled§rbrack[]



   §textbf[6.13.5]  §textbf[Deleting] §textbf[an] §textbf[Archived] §textbf[File]
   ...
   §textbf[6.13.6]  §textbf[Archiving] §textbf[Expired] §textbf[Files] §textbf[Automatically]
...

   ...
   On-line expiration dates are displayed with the DIRECTORY command:
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[,]
        @@§uline[DATES] (OF) §uline[ONLINE-EXPIRATION]
        @@
   ...
   ONLINE-EXPIRATION-DEFAULT command:
        ...
        @§uline[SET] §uline[DIRECTORY] §uline[ONLINE-EXPIRATION-DEFAULT] (OF DIRECTORY) -
        §uline[<TUCKER>] (TO) §uline[26-NOV-88]

   You can specify a time interval rather than a specific date:

        @§uline[SET] §uline[DIRECTORY] §uline[ONLINE-EXPIRATION-DEFAULT] (OF DIRECTORY) -
        §uline[<TUCKER>] (TO) §uline[+30]
   ...
   You can also establish on-line expiration dates for individual files:
        ...
        @§uline[SET] §uline[FILE] §uline[ONLINE-EXPIRATION] (OF FILES) §uline[MEMO.INI] (TO) §uline[+120]
        MEMO.INI.1 §lbrack[]OK§rbrack[]

   If you want a file to be immediately available for archiving, give the
   SET FILE EXPIRED command:

        @§uline[SET] §uline[FILE] §uline[EXPIRED] (FILES) §uline[PENDING.Q]
        PENDING.Q.11 §lbrack[]OK§rbrack[]
   ...
   when the expiration dates are reached:
        ...
        @§uline[SET] §uline[DIRECTORY] §uline[ARCHIVE-ONLINE-EXPIRED-FILES] (OF DIRECTORY) - 
         §uline[<TUCKER>]
...

   ...
   until a possible forced migration:
        ...
        @§uline[SET] §uline[DIRECTORY] §uline[NO] §uline[ARCHIVE-ONLINE-EXPIRED-FILES] (OF DIRECTORY) - 
         §uline[<TUCKER>]
   ...
   archived, give the INFORMATION DIRECTORY command:
        ...
        @§uline[INFORMATION] (ABOUT) §uline[DIRECTORY] (DIRECTORY NAME) §uline[<TUCKER>]
        Name PS:<TUCKER>
             .
             .
   ...
   §textbf[6.14]  §textbf[VISIBLE] §textbf[AND] §textbf[INVISIBLE] §textbf[FILES]
...

   ...
   §textbf[7.1]  §textbf[USING] §textbf[MAGNETIC] §textbf[TAPE] §textbf[STORAGE]
   ...
   to  the  §uline[TOPS-20]  §uline[User]  §uline[Utilities]  §uline[Guide].)  Tapes  can  be labelled or
   ...
   on the outside of the tape reel.  Refer to the §uline[TOPS-20] §uline[Tape] §uline[Processing]
   §uline[Manual] for more information on labelled and unlabelled tapes.



   §textbf[7.2]  §textbf[USING] §textbf[UNLABELLED] §textbf[TAPES]
   ...
   (Refer to the §uline[TOPS-20] §uline[System] §uline[Manager's] §uline[Guide]  for  an  explanation  of
   tape allocation.)
...

   ...
   §textbf[7.2.1]  §textbf[Using] §textbf[Unlabelled] §textbf[Tapes] §textbf[with] §textbf[Tape] §textbf[Allocation] §textbf[Enabled]
   ...
   tape is mounted.
        ...
        @§uline[MOUNT] §uline[TAPE] (NAME) §uline[ACE1:]
        §lbrack[]Tape set ACE1, volume ACE1 mounted§rbrack[]
        §lbrack[]ACE1:  defined as MT0:§rbrack[]
   ...
   by giving the INFORMATION MOUNT-REQUESTS command.
        ...
        @§uline[MOUNT] §uline[TAPE] (NAME) §uline[ACE1:] §uline[/NOWAIT]
   ...
   the tape is dismounted.
        ...
        @§uline[DISMOUNT] §uline[TAPE] (NAME) §uline[ACE1:]
        §lbrack[]Tape dismounted, logical name ACE1: deleted§rbrack[]



   §textbf[7.2.2]  §textbf[Using] §textbf[Unlabeled] §textbf[Tapes] §textbf[with] §textbf[Tape] §textbf[Allocation] §textbf[Disabled]
   ...
   available, give the INFORMATION AVAILABLE-DEVICES command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[AVAILABLE-DEVICES]
...

   ...
   assigning drive 2.
        ...
        @§uline[ASSIGN] (DEVICE) §uline[MTA2:]
   ...
   and ask the operator to mount your tape.
        ...
        §uline[Please] §uline[mount] §uline[tape] §uline[TEST:]<CTRL/Z>
        §lbrack[]PLSOPN Operator at GIDNEY has been notified at 11:18:32§rbrack[]
   ...
   §textbf[7.2.3]  §textbf[Setting] §textbf[Tape] §textbf[Parameters]
   ...
   command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[TAPE-PARAMETERS]
   ...
   any of the parameters, give the SET TAPE command.
        ...
        @§uline[SET] §uline[TAPE] §uline[DENSITY] §uline[(TO)] §uline[800]
...

   ...
   defaults.  For a complete description of DUMPER, refer to the  §uline[TOPS-20]
   §uline[User] §uline[Utilities] §uline[Guide].



   §textbf[7.2.4]  §textbf[Positioning] §textbf[the] §textbf[Tape]
   ...
   certain number of files on labeled tapes.
        ...
        @§uline[SKIP] (DEVICE) §uline[MTA2:] §uline[4] §uline[FILES]



   §textbf[7.3]  §textbf[USING] §textbf[LABELLED] §textbf[TAPES]
   ...
   the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].
        ...
        @§uline[MOUNT] §uline[TAPE] (NAME) §uline[ABCD:/NEW]
        §lbrack[]Tape set ABCD, volume 002001 mounted§rbrack[]
        §lbrack[]TEST:  defined as MT2:§rbrack[]
...

   ...
   of 002001, 002002, and 002003:
        ...
        @§uline[INFORMATION] (ABOUT) §uline[VOLUMES] (OF TAPE) §uline[ABCD:]
   ...
   tape setname and the /VOLIDS:  switch in the MOUNT TAPE command.
        ...
        @§uline[MOUNT] §uline[TAPE] (NAME) §uline[ABCD:/VOLIDS:] §uline[002001,002002,002003]
        §lbrack[]Tape set ABCD, volume 002001 mounted§rbrack[]
        §lbrack[]ABCD: defined as MT2:§rbrack[]
   ...
   ABCD:, give the following command.
        ...
        @§uline[MOUNT] §uline[TAPE] (NAME) §uline[ABCD:/VOLIDS:002001,002002,002003]  §uline[-]
        §uline[/START:VOLUME] §uline[002002]
        §lbrack[]Tape set ABCD, volume 002002 mounted§rbrack[]
        §lbrack[]ABCD:  defined as MT0:§rbrack[]
   ...
   the queue, and indicates the status of the request.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[MOUNT-REQUESTS]
...

   ...
   operator has not mounted the tape.
        ...
        @§uline[CANCEL] (REQUEST TYPE) §uline[MOUNT] §uline[ABCD:]
   ...
   command, followed by the tape setname.
        ...
        @§uline[DISMOUNT] §uline[TAPE] §uline[ABCD:]
        §lbrack[]Tape dismounted, Logical name ABCD:  deleted§rbrack[]
...

   ...
   §textbf[8.1]  §textbf[RUNNING] §textbf[SYSTEM] §textbf[PROGRAMS]
...

   ...
   start the DUMPER program:
        ...
        @§uline[DUMPER]                  !Type DUMPER and press RETURN.
        DUMPER>                  !DUMPER starts
                                 !And waits for a command



   §textbf[8.2]  §textbf[GIVING] §textbf[COMMANDS] §textbf[TO] §textbf[SYSTEM] §textbf[PROGRAMS]
...

   ...
   §textbf[8.2.1]  §textbf[Example:]  §textbf[Using] §textbf[a] §textbf[System] §textbf[Program]
   ...
   indicates the differences between them, works as follows:
        ...
        1.  Create two files that are similar but not identical.  You may
            ...
            @§uline[CREATE] (FILE) §uline[FIRST.FIL]
            Input:  FIRST.FIL.1
            00100           TYPE 101
            ...
            §lbrack[]FIRST.FIL.1§rbrack[]
            @

            @§uline[CREATE] (FILE) §uline[SECOND.FIL]
            Input:  SECOND.FIL.1
            00100           TYPE 101
        ...
        3.  Tell FILCOM which files to compare and what to  do  with  the
            results of the comparison.  For this example, type the line:
                 ...
                 *§uline[TTY:=FIRST.FIL,SECOND.FIL]
            ...
            type the line:
                 ...
                 *§uline[PROG.DIF=FIRST.FIL,SECOND.FIL]
...

        ...
        4.  Press RETURN at the end of the line to execute the command
            ...
            *§uline[TTY:=FIRST.FIL,SECOND.FIL]
            File 1) DSK:FIRST.FIL§lbrack[]4,16§rbrack[]     created: 0837 10-Jun-1988
            File 2) DSK:SECOND.FIL§lbrack[]4,16§rbrack[]    created: 0839 10-Jun-1988
   ...
   does this.
        ...
        *§uline[TTY:=FIRST.FIL,SECOND.FIL/U]
...

   ...
   §textbf[8.3]  §textbf[GETTING] §textbf[INFORMATION] §textbf[ABOUT] §textbf[SYSTEM] §textbf[FEATURES]
   ...
   which it has information.
        ...
        @§uline[HELP] §uline[?] one of the following:
...

   ...
   §textbf[8.4]  §textbf[RUNNING] §textbf[USER] §textbf[PROGRAMS]
   ...
   the RUN command.  In the following example, run the program LESTSQ:
        ...
        @§uline[RUN] (PROGRAM) §uline[LESTSQ]
...

   ...
   RUN command:
        ...
        @§uline[RUN] (PROGRAM) §uline[<HOLLAND>TEST]
   ...
   §textbf[8.5]  §textbf[CONTROLLING] §textbf[PROGRAMS]
   ...
   §textbf[8.5.1]  §textbf[Typing] §textbf[CTRL/C] §textbf[to] §textbf[Halt] §textbf[Execution]
   ...
   You may want to stop your program for several reasons.
      ...
      decide to stop your program.
        ...
        @§uline[EXECUTE] (FROM) §uline[SQRT.ALG]
        ALGOL:  SQRT
        LINK:  Loading
...

   ...
   §textbf[8.5.2]  §textbf[Typing] §textbf[CTRL/O] §textbf[to] §textbf[Stop] §textbf[Output] §textbf[to] §textbf[Your] §textbf[Terminal]
   ...
   command) finishes, the system prints the TOPS-20 prompt.
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[*.FOR]
   ...
   CTRL/O.
        ...
        @§uline[DIRECTORY] (OF FILES) §uline[*.CBL]
...

   ...
   §textbf[8.5.3]  §textbf[Typing] §textbf[CTRL/T] §textbf[to] §textbf[Print] §textbf[the] §textbf[Run] §textbf[Status]
   ...
   minutes and 2 seconds.
        ...
        Load  2.08
        LINK:  Loading
        §lbrack[]LNKXCT SQRT Execution§rbrack[]

         TYPE THE VALUE OF X:  §uline[4]
...

   ...
   §textbf[Table] §textbf[8-1:]  §textbf[CTRL/T] §textbf[Status] §textbf[Messages]
   ...
   _______________________________________________________________________
     ...
     Refer  to the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual] for information on
     SET TYPEOUT MODE.
   ...
   response.  Refer to the §uline[TOPS-20] §uline[WATCH] document for further information
   on load averages.
...

   ...
   §textbf[Table] §textbf[8-2:]  §textbf[Unexpected] §textbf[Process] §textbf[Termination] §textbf[Messages]
...

   ...
   §textbf[8.6]  §textbf[RUNNING] §textbf[PROGRAMS] §textbf[WITHOUT] §textbf[DESTROYING] §textbf[MEMORY]
   ...
   command; and continue the program.
        ...
        @§uline[EXECUTE] (FROM) §uline[RANK.FOR]      !Execute the program
        FORTRAN: RANK
        LINK:   Loading
        §lbrack[]LNKXCT RANK Execution§rbrack[]
        ...
        *§uline[^C]                           !type CTRL/C to stop
        @§uline[PUSH] (COMMAND LEVEL)         !Save the program and set up
                                       a new copy of memory
         TOPS-20 Command processor 6.1(7)
        @§uline[CREATE] (FILE) §uline[NUMBER.DAT]
             .
             .
             .
        @§uline[POP] (COMMAND LEVEL)          !Return to the last command level
        @§uline[CONTINUE]                     !Resume execution
        §uline[NUMBER.DAT]                    !Type the name of the file
...

   ...
   §textbf[8.7]  §textbf[RUNNING] §textbf[MULTIPLE] §textbf[PROGRAMS]
...

   ...
   §textbf[Figure] §textbf[8-1:]  §textbf[Methods] §textbf[of] §textbf[Running] §textbf[Multiple] §textbf[Programs]
...

   ...
   §textbf[8.7.1]  §textbf[Saving] §textbf[Forks]
   ...
   KEEPing  forks,  see  the  SET PROGRAM command in the §uline[TOPS-20] §uline[Commands]
   §uline[Reference] §uline[Manual].
...

   ...
   §textbf[8.7.2]  §textbf[Changing] §textbf[the] §textbf[Current] §textbf[Fork]
   ...
   §textbf[8.7.3]  §textbf[Creating] §textbf[Background] §textbf[Forks]
   ...
   Check the status of BLISS with the INFORMATION FORK-STATUS command.
        ...
        @§uline[CONTINUE] §uline[BLISS]
        BLISS>§uline[PROBE.BLI]
...

   ...
   input by ringing the terminal bell and printing  the  message  §lbrack[]BLISS:
   wants the TTY§rbrack[].

   Because EDIT is in a kept fork, you can continue  EDIT  at  its  start
   address by typing EDIT.

        @§uline[EDIT]
        §lbrack[]Starting§rbrack[]
        Edit: CHECK.TXT
        *

   The §lbrack[]Starting§rbrack[] message indicates that the kept fork was  continued  at
   ...
   (For  more  information  on  the  SET PROGRAM command, see the §uline[TOPS-20]
   §uline[Commands] §uline[Reference] §uline[Manual]).



   §textbf[8.7.4]  §textbf[Deleting] §textbf[Forks]
...

   ...
   §textbf[9.1]  §textbf[PRODUCING] §textbf[A] §textbf[SIMPLE] §textbf[PROGRAM]
   ...
   §textbf[9.1.1]  §textbf[The] §textbf[Source] §textbf[Program]
   ...
   This translated program is called an §uline[object] §uline[program].
...

   ...
   §textbf[9.1.2]  §textbf[Executing] §textbf[the] §textbf[Program]
   ...
   commands are referred to as LOAD-class commands.
        ...
        @§uline[EXECUTE] (FROM) §uline[SMALL.FOR]
        FORTRAN: SMALL
        MAIN.
        LINK:   Loading
        §lbrack[]LNKXCT SMALL Execution§rbrack[]

        TYPE A NUMBER: §uline[5]
...

   ...
   §textbf[9.1.3]  §textbf[Debugging] §textbf[the] §textbf[Program]
   ...
   shows how to recompile the program SMALL and get a listing:
        ...
        @§uline[COMPILE] (FROM) §uline[SMALL/LIST/COMPILE]
        FORTRAN: SMALL
        MAIN.
        @
...

   ...
   §textbf[9.1.4]  §textbf[Saving] §textbf[the] §textbf[Program] §textbf[for] §textbf[Future] §textbf[Use]
   ...
   To run the program, give a RUN command.
        ...
        @§uline[RUN] §uline[SMALL]

        TYPE A NUMBER: §uline[25]
...

   ...
   §textbf[9.2]  §textbf[PREPARING] §textbf[A] §textbf[MULTI-MODULE] §textbf[PROGRAM]
   ...
   §textbf[9.2.1]  §textbf[Writing] §textbf[and] §textbf[Entering] §textbf[Modules] §textbf[into] §textbf[Files]
...

   ...
   §textbf[9.2.2]  §textbf[Executing] §textbf[the] §textbf[Program]
   ...
   starts them.
        ...
        @§uline[EXECUTE] (FROM) §uline[COMP,ADDEM,DIFFER]
        FORTRAN: COMP
        MAIN.
        FORTRAN: ADDEM
             .
   ...
   §textbf[9.2.3]  §textbf[Producing] §textbf[a] §textbf[Cross-Reference] §textbf[Listing]
...

   ...
   listing for the COMP, ADDEM, and DIFFER programs.
        ...
        @§uline[EXECUTE] (FROM) §uline[/CREF] §uline[COMP,ADDEM,DIFFER]  !Include /CREF
        FORTRAN: COMP
        MAIN.
        FORTRAN: ADDEM
             .
   ...
   listings:
        ...
        @§uline[COMPILE] (FROM) §uline[/CREF] §uline[/NOBINARY] §uline[/COMPILE] §uline[COMP,ADDEM,DIFFER]
        FORTRAN: COMP
        MAIN.
        FORTRAN: ADDEM
        ADDEM
...

   ...
   §textbf[9.2.4]  §textbf[Using] §textbf[Subroutine] §textbf[Libraries]
...

   ...
   §textbf[9.2.4.1]  §textbf[Entering] §textbf[the] §textbf[Subroutines] §textbf[into] §textbf[Files] - Enter  the  subroutines
   into separate files.
   ...
   §textbf[9.2.4.2]  §textbf[Compiling] §textbf[the] §textbf[Subroutines] - After  entering  the  subroutines
   into files, compile them to produce four separate object files.

        @§uline[COMPILE] (FROM) §uline[OPREAD,OPWRIT,CLREAD,CLWRIT]
        FORTRAN: OPREAD
        OPREAD
        FORTRAN: OPWRIT
        OPWRIT
...

   ...
   §textbf[9.2.4.3]  §textbf[Creating]  §textbf[the]  §textbf[Library]  §textbf[File] - Create  the  library  file  by
   ...
   each object file, followed by the /APPEND switch.
        ...
        @§uline[MAKLIB]
        *§uline[DOFILE=OPREAD/APPEND,OPWRIT/APPEND,CLREAD/APPEND,CLWRIT/APPEND]
   ...
   SWITCH.INI  file  in  your  §textbf[connected]  §textbf[directory] and uses the switches
...

        ...
        DSK:DOFILE.REL§lbrack[]4,164§rbrack[] Created on 26-Mar-88 at 15:00:00
   ...
   §textbf[9.2.4.4]  §textbf[Using] §textbf[the] §textbf[Library]  §textbf[File] - To  use  the  library  file,  first
   ...
   start it.  Remember to include the /LIBRARY switch.
        ...
        @§uline[LOAD] (FROM) §uline[WRITER,DOFILE/LIBRARY]
        FORTRAN: WRITER
        MAIN.
        LINK:   Loading
...

   ...
   §textbf[9.2.4.5]  §textbf[Changing] §textbf[a] §textbf[Subroutine] §textbf[in] §textbf[the] §textbf[Library] - To change a subroutine
   ...
   new object file.
        ...
        @§uline[COMPILE] (FROM) §uline[OPWRIT.FOR]
        FORTRAN: OPWRIT
        OPWRIT
   ...
   file to be sure you are updating the proper file.
        ...
        *§uline[TTY:=DOFILE/LIST]
        ...
        DSK:DOFILE.REL§lbrack[]4,164§rbrack[] Created on 26-Sep-88 at 15:00:00
   ...
   it prints an asterisk.
        ...
        *§uline[DOFILE=DOFILE/MASTER:OPWRIT,OPWRIT/REPLACE]
   ...
   changed to include the additional statements.
        ...
        *§uline[TTY:=DOFILE/LIST]
        ...
        DSK:DOFILE.REL§lbrack[]4,164§rbrack[] Created on 26-sep-88 at 15:09:00
...

   ...
   Refer to the §uline[TOPS-20] §uline[User] §uline[Utilities] §uline[Guide] for more information on  the
   MAKLIB program.



   §textbf[9.2.5]  §textbf[Loading] §textbf[and] §textbf[Saving] §textbf[the] §textbf[Program] §textbf[for] §textbf[Future] §textbf[Use]
   ...
   will reflect that name.
        ...
        @§uline[RUN] (PROGRAM) §uline[WRITER]
...

   ...
   §textbf[9.2.6]  §textbf[Saving] §textbf[Arguments] §textbf[in] §textbf[Indirect] §textbf[Files]
   ...
   subroutines:
        ...
        §uline[OPREAD,OPWRIT,CLREAD,CLWRIT]
   ...
   WRITER and to search the library:
        ...
        §uline[WRITER.FOR,DOFILE.REL/LIBRARY]



   §textbf[9.2.7]  §textbf[Comparing] §textbf[Changes] §textbf[in] §textbf[Files]
...

   ...
   UPDATE.FOR.  This example uses the EDIT editor.
        ...
        @§uline[EDIT] (FILE) §uline[WRITER.FOR.1] (OUTPUT AS) §uline[UPDATE.FOR]
        Edit: WRITER.FOR.1
        *§uline[F=>$]
        00700   102   FORMAT (' => UPDATED ON: ', A10)
        *§uline[SUPDATED$ADDED] §uline[NEW] §uline[DATA$.]
        00700   102   FORMAT (' => ADDED NEW DATA ON: ', A10)
        *§uline[E]

        §lbrack[]UPDATE.FOR.1§rbrack[]
   ...
   your terminal.  Type a CTRL/C to end FILCOM.
        ...
        @§uline[FILCOM]                            !Start FILCOM

        *§uline[TTY:=WRITER.FOR,UPDATE.FOR]        !Type the command
        ...
        *§uline[^C]                                !Type a CTRL/C to
                                           !end FILCOM

   For more information on the  FILCOM  program,  see  the  §uline[TOPS-20]  §uline[User]
   §uline[Utilities] §uline[Guide].



   §textbf[9.3]  §textbf[USING] §textbf[THE] §textbf[LOAD-CLASS] §textbf[COMMANDS]
...

   ...
   §textbf[9.3.1]  §textbf[Object] §textbf[(Relocatable)] §textbf[and] §textbf[Executable] §textbf[Programs]
...

   ...
   §textbf[Figure] §textbf[9-1:]  §textbf[Source,] §textbf[Object,] §textbf[and] §textbf[Executable] §textbf[Programs]
...

   ...
   §textbf[9.3.1.1]  §textbf[Using] §textbf[Relocatable] §textbf[Object] §textbf[Programs] - Once you compile a source
   ...
   To run TESTER, give the command:
        ...
        @§uline[EXECUTE] (FROM) §uline[TESTER,FILLER]
   ...
   you must include in the EXECUTE command.
        ...
        @§uline[EXECUTE] (FROM) §uline[LAYOUT,FILLER,TTYOUT]
   ...
   the EXECUTE command.
        ...
        @§uline[EXECUTE] (FROM) §uline[GAMMA,POLAR,FILLER]
   ...
   §textbf[9.3.2]  §textbf[Selecting] §textbf[a] §textbf[File] §textbf[and] §textbf[Recognizing] §textbf[the] §textbf[Programming] §textbf[Language]
   ...
   command:
        ...
        @§uline[COMPILE] (FROM) §uline[SMALL]
        FORTRAN:  SMALL
        MAIN.
...

   ...
   §textbf[Table] §textbf[9-1:]  §textbf[LOAD-Class] §textbf[Command] §textbf[Standard] §textbf[File] §textbf[Types]
...

   ...
   §textbf[9.3.2.1]  §textbf[Using] §textbf[Nonstandard] §textbf[File] §textbf[Types] - If you include a file type  in
   ...
   file types shown in Table 9-1, the system uses the FORTRAN compiler.
        ...
        @§uline[COMPILE] (FROM) §uline[TEST.REF]
        FORTRAN: TEST
        MAIN.
   ...
   include one of the compiler switches after the file specification.
        ...
        @§uline[COMPILE] (FROM) §uline[ENABLE.MON/MACRO]
        MACRO: ENABLE



   §textbf[9.3.2.2]  §textbf[Setting] §textbf[a] §textbf[Default] §textbf[Compiler] - You can set a  default  compiler
   ...
   §textbf[9.3.2.3]  §textbf[Using] §textbf[the] §textbf[File] §textbf[Type] §textbf[.REL] - If you want to  use  a  particular
   ...
   does not attempt to compile this file; it simply loads it into memory.
        ...
        @§uline[LOAD] (FROM) §uline[START.REL]
        LINK:   Loading
...

   ...
   to compile the object program as a source program.
        ...
        @§uline[LOAD] (FROM) §uline[MIDDLE.OBJ/RELOCATABLE]
        LINK:   Loading
   ...
   §textbf[9.3.2.4]  §textbf[Examples] - If you have the file TRYIT.FOR.1 and you give  the
   following command:
   ...
   §textbf[9.3.3]  §textbf[Compiling] §textbf[Only] §textbf[Out-of-Date] §textbf[Object] §textbf[Programs]
...

   ...
   §textbf[9.3.4]  §textbf[Remembering] §textbf[Arguments] §textbf[to] §textbf[LOAD-Class] §textbf[Commands]
   ...
   following sequence of commands:
        ...
        @§uline[COMPILE] (FROM) §uline[TEST.FOR,SUB1.FOR]
        @§uline[EXECUTE] (FROM)
   ...
   Suppose you give the command:
        ...
        @§uline[COMPILE] (FROM) §uline[/CREF/COBOL] §uline[MANCOB,TTYIN,TTYOUT,LPOUT]

   then the command:

        @§uline[LOAD] (FROM) §uline[/MAP]
   ...
   command:
        ...
        @§uline[LOAD] (FROM) §uline[/MAP/CREF/COBOL] §uline[MANCOB,TTYIN,TTYOUT,LPOUT]

   If your next command is:

        @§uline[COMPILE] (FROM) §uline[/COMPILE]

   the system executes the command:

        @§uline[COMPILE] (FROM) §uline[/COMPILE/CREF/COBOL] §uline[MANCOB,TTYIN,TTYOUT,LPOUT]

   Notice this command  does not include the /MAP switch.  The command:

        @§uline[EXECUTE] §uline[(FROM)] §uline[LINER.MAC]
...

   ...
   §textbf[9.3.5]  §textbf[Concatenating] §textbf[Files] §textbf[to] §textbf[Produce] §textbf[One] §textbf[Source] §textbf[Program]
   ...
   §textbf[9.3.6]  §textbf[Specifying] §textbf[Special] §textbf[Actions] §textbf[with] §textbf[Switches]

   You can supply various switches with the LOAD-class  commands.   Refer
   to the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual] for a complete description of
   ...
   command:
        ...
        @§uline[COMPILE] (FROM) §uline[/FORTRAN] §uline[SCHED.R1,ENA.R1,DIS.R1]
...

   ...
   could modify your command as follows:
        ...
        @§uline[LOAD] (FROM) §uline[/FORTRAN] §uline[SCHED.R1,ENA.R1,MONINT.R1/COBOL,DIS.R1]
   ...
   is:
        ...
        @§uline[LOAD] /§uline[FORTRAN] §uline[SCHED.R1,ENA.R1,DIS.R1,/COBOL] §uline[MON1.R1,MON2.R1]
...

   ...
   §textbf[10.1]  §textbf[PREPARING] §textbf[A] §textbf[BATCH] §textbf[JOB]
...

   ...
   §textbf[Table] §textbf[10-1:]  §textbf[Illegal] §textbf[Commands] §textbf[in] §textbf[Batch] §textbf[Jobs]
...

   ...
   §textbf[10.1.1]  §textbf[Creating] §textbf[a] §textbf[Control] §textbf[File]
   ...
   §textbf[10.1.2]  §textbf[Monitoring] §textbf[Your] §textbf[Batch] §textbf[Job]
   ...
   §uline[TOPS-20]  §uline[User]  §uline[Utilities] §uline[Guide] for information on the MAIL program or,
   if  you  are  using  the  DECmail/MS  mail  program,  refer   to   the
   §uline[TOPS-10/TOPS-20] §uline[DECmail/MS] §uline[Manual]).



   §textbf[10.1.3]  §textbf[Submitting] §textbf[a] §textbf[Control] §textbf[File] §textbf[to] §textbf[Batch]
   ...
   include the file type in the command.
        ...
        @§uline[SUBMIT] (BATCH JOB) §uline[TEST]
        §lbrack[]Job TEST Queued, Request-ID 105, Limit 0:05:00§rbrack[]
   ...
   and DATA.CTL:
        ...
        @§uline[SUBMIT] (BATCH JOB) §uline[TEST,DATA]
        §lbrack[]Job TEST Queued, Request-ID 106, Limit 0:05:00§rbrack[]
        §lbrack[]Job DATA Queued, Request-ID 107, Limit 0:05:00§rbrack[]
...

   ...
   submit TEST.CTL and DATA.CTL using a global switch /AFTER:.
        ...
        @§uline[SUBMIT] (BATCH JOB)§uline[/AFTER:8-Jun-88] §uline[TEST,DATA]
        §lbrack[]Job TEST Queued, Request-ID 108, Limit 0:05:00§rbrack[]
        §lbrack[]Job DATA Queued, Request-ID 109, Limit 0:05:00§rbrack[]
   ...
   DATA.CTL:
        ...
        @§uline[SUBMIT] (BATCH JOB) §uline[TEST/AFTER:10-Jun-88,DATA]
        §lbrack[]Job TEST Queued, Request-ID 110, Limit 0:05:00§rbrack[]
        §lbrack[]Job DATA Queued, Request-ID 111, Limit 0:05:00§rbrack[]



   §textbf[10.1.3.1]  §textbf[Setting] §textbf[Defaults] §textbf[for] §textbf[the] §textbf[SUBMIT] §textbf[Command] - If  you  want  the
   ...
   give the INFORMATION (ABOUT) DEFAULTS (FOR) SUBMIT command.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[DEFAULTS] (FOR) §uline[SUBMIT]
   ...
   §textbf[10.1.4]  §textbf[Checking] §textbf[a] §textbf[Batch] §textbf[Job]
...

   ...
   user's job, use the /USER:  switch, followed by the user's name.
        ...
        @§uline[INFORMATION] (ABOUT) §uline[BATCH-REQUESTS]
   ...
   §textbf[10.1.5]  §textbf[Examining] §textbf[the] §textbf[Output] §textbf[from] §textbf[a] §textbf[Batch] §textbf[Job]
   ...
   directory with the control file.
        @§uline[DIRECTORY] (OF FILES) §uline[TEST]
...

   ...
   13:20:39 MONTR  §lbrack[]PUBLIC Mounted§rbrack[]
   13:20:39 MONTR
   13:20:39 MONTR  §lbrack[]CONNECTED TO PUBLIC:<EMORRILL>§rbrack[]
   ...
   13:20:44 MONTR  §lbrack[]Printer job SAMPLE queued, request #89, limit 3§rbrack[]
   13:20:44 MONTR  @
   ...
   For a detailed description of  batch,  refer  to  the  §uline[TOPS-10/TOPS-20]
   §uline[Batch] §uline[Reference] §uline[Manual].



   §textbf[10.2]  §textbf[MODIFYING] §textbf[A] §textbf[BATCH] §textbf[JOB]
...

   ...
   switches you can modify, and reprints the command line.
        ...
        @§uline[MODIFY] (REQUEST TYPE) §uline[BATCH/?] Switch, or parameter to modify, one 
        of the following:
   ...
   /AFTER:  switch and the date August 15, 1988:
        ...
        @§uline[MODIFY] (REQUEST TYPE) §uline[BATCH] (ID) §uline[TEST/AFTER:15-AUG-88]
        §lbrack[]1 Job Modified§rbrack[]



   §textbf[10.3]  §textbf[CANCELING] §textbf[A] §textbf[BATCH] §textbf[JOB]
   ...
   §lbrack[]1 Job Canceled§rbrack[].  If the system is processing the entry in the  queue
   when  you  give  the  CANCEL  command, it stops the job and prints the
   message, §lbrack[]1 Job Canceled, (1 was in progress)§rbrack[].

   In the following example, remove the batch job TEST.CTL.

        @§uline[CANCEL] (REQUEST TYPE) §uline[BATCH] (ID) §uline[TEST]
        §lbrack[]1 Job Canceled§rbrack[]
   ...
   example shows how to remove all of your batch jobs:
        ...
        @§uline[CANCEL] (REQUEST TYPE) §uline[BATCH] §uline[*]
...

   ...
   description  of  all  TOPS-20  commands, refer to the §uline[TOPS-20] §uline[Commands]
   §uline[Reference] §uline[Manual].
...

   ...
   §textbf[A.3]  §textbf[DEVICE] §textbf[HANDLING] §textbf[COMMANDS]
...

   ...
   §textbf[A.7]  §textbf[BATCH] §textbf[COMMAND]
...

   ...
   §textbf[Table] §textbf[B-1:]  §textbf[Standard] §textbf[File] §textbf[Types]
...

   ...
   §textbf[C.1]  §textbf[ENTERING] §textbf[YOUR] §textbf[FORTRAN] §textbf[PROGRAM]
   ...
   appendix.
        ...
        @§uline[CREATE] (FILE) §uline[ADDTWO.FOR]
        Input: ADDTWO.FOR.1
...

   ...
   program.
        ...
        @§uline[EXECUTE] (FROM) §uline[ADDTWO.FOR]
        FORTRAN: ADDTWO
   ...
   §textbf[C.2]  §textbf[EDITING] §textbf[YOUR] §textbf[FORTRAN] §textbf[PROGRAM]

   You can remove the errors in your program by using the EDIT program.



   §textbf[C.2.1]  §textbf[Starting] §textbf[EDIT]
...

   ...
   prints an asterisk.
        ...
        @§uline[EDIT] (FILE) §uline[ADDTWO.FOR]
        Edit: ADDTWO.FOR.1
        *
   ...
   §textbf[C.2.2]  §textbf[Printing] §textbf[a] §textbf[Line]
...

   ...
   §textbf[C.2.3]  §textbf[Inserting] §textbf[a] §textbf[Line]
   ...
   The command I450 inserts the new line number 450 into you program.
        ...
        *§uline[I450]
        00450  §uline[102]<TAB> §uline[FORMAT] §uline[(2F)]
        *
...

   ...
   §textbf[C.2.4]  §textbf[Deleting] §textbf[a] §textbf[Line]
...

   ...
   §textbf[C.2.5]  §textbf[Replacing] §textbf[a] §textbf[Line]
   ...
   §textbf[C.2.6]  §textbf[Changing] §textbf[a] §textbf[Line] §textbf[Without] §textbf[Completely] §textbf[Retyping] §textbf[It]
...

   ...
   with FORMAT.
        ...
        *§uline[SFIRMAT]<ESC>§uline[FORMAT]<ESC>§uline[800]<RET>
   ...
   §textbf[C.2.7]  §textbf[Saving] §textbf[a] §textbf[File]
   ...
   TOPS-20 command levels.
        ...
        *§uline[E]
        ...
        §lbrack[]ADDTWO.FOR.2§rbrack[]
        @



   §textbf[C.3]  §textbf[RERUNNING] §textbf[A] §textbf[FORTRAN] §textbf[PROGRAM]
...

   ...
   §textbf[C.3.1]  §textbf[Typing] §textbf[Out] §textbf[Your] §textbf[Program]
...

   ...
   §textbf[D.1]  §textbf[STARTING] §textbf[BASIC]
   ...
   §textbf[D.2]  §textbf[ENTERING] §textbf[YOUR] §textbf[PROGRAM]
...

   ...
   §textbf[D.3]  §textbf[SAVING] §textbf[YOUR] §textbf[PROGRAM]
...

   ...
   §textbf[D.4]  §textbf[RUNNING] §textbf[YOUR] §textbf[PROGRAM]
   ...
   §textbf[D.5]  §textbf[EDITING] §textbf[YOUR] §textbf[PROGRAM]
   ...
   To edit the program in your working area:
        ...
        3.  Press the RETURN key.
                 ...
                 §uline[500] §uline[PRINT] §uline["THE] §uline[SQUAREROOT] §uline[OF] §uline[";X;"] §uline[IS] §uline[";Y]



   §textbf[D.6]  §textbf[RENAMING] §textbf[YOUR] §textbf[PROGRAM]
...

   ...
   §textbf[D.7]  §textbf[RERUNNING] §textbf[YOUR] §textbf[PROGRAM]
   ...
   §textbf[D.8]  §textbf[LISTING] §textbf[YOUR] §textbf[PROGRAM]
...

   ...
   §textbf[D.9]  §textbf[RUNNING] §textbf[AN] §textbf[EXISTING] §textbf[PROGRAM]
   ...
   §textbf[D.10]  §textbf[LEAVING] §textbf[BASIC]
...

   ...
   Key                                 Migration of files, 6-23
     ...
     Tab, 1-3                          Mount count, 6-3
               ...
               §textbf[-L-]                     MOUNT TAPE command, 7-2, 7-4
                                       Multiforking, 8-13
   Labelled tapes, 7-1
     using, 7-4
   Library file, 9-8
     creating a, 9-10                              §textbf[-N-]
     subroutine, 9-8
...

   ...
   On-line expiration date, 6-27       Restoring files, 6-20
               ...
               §textbf[-P-]                     Return key, 1-3
                                       RUN command, 8-6, 9-4
   Page length
     terminal, 1-19                                §textbf[-S-]
   Passwords, 1-14
