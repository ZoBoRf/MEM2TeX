...
pdfcreationdate={D:20200823201759},
...

   ...
   §uline[Document] §uline[Structure]
...

   ...
   §uline[Reference] §uline[Material]

        §uline[TOPS-20] §uline[User's] §uline[Guide]

        §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual]

        §uline[MACRO] §uline[Assembler] §uline[Reference] §uline[Manual]

        §uline[FORTRAN] §uline[Language] §uline[Manual]

        §uline[COBOL-68] §uline[Language] §uline[Manual]

        §uline[COBOL-74] §uline[Language] §uline[Manual]

        §uline[DECsystem-10/DECSYSTEM-20] §uline[Processor] §uline[Reference] §uline[Manual]
   ...
   §uline[Loading] §uline[Map]

   To load most programs,

        1.  Become familiar with the concepts in the §uline[TOPS-20] §uline[User's] §uline[Guide]
            and §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].
...

        ...
        1.  Become familiar with the concepts in
            ...
            the §uline[DECsystem-10/DECSYSTEM-20] §uline[Processor] §uline[Reference] §uline[Manual]

            the Chapter 8 of the §uline[TOPS-20] §uline[Monitor] §uline[Calls] §uline[User's] §uline[Guide]
...

                                 ...
                                 §textbf[CHAPTER] §textbf[1]

                            §textbf[INTRODUCTION] §textbf[TO] §textbf[LINK]
...

   ...
   §textbf[1.1]  §textbf[INPUT] §textbf[TO] §textbf[LINK]
   ...
   §textbf[1.1.1]  §textbf[Object] §textbf[Modules]
...

   ...
   §textbf[1.1.2]  §textbf[Commands] §textbf[to] §textbf[LINK]
   ...
   §textbf[1.1.3]  §textbf[Libraries] §textbf[And] §textbf[Searches]
...

   ...
   §textbf[1.2]  §textbf[OUTPUT] §textbf[FROM] §textbf[LINK]
   ...
   §textbf[1.2.1]  §textbf[Executable] §textbf[Program]
...

   ...
   §textbf[1.2.3]  §textbf[Special] §textbf[Files]
   ...
   §textbf[1.3]  §textbf[LINK'S] §textbf[OVERLAY] §textbf[FACILITY]
   ...
   §textbf[1.4]  §textbf[LINK] §textbf[AND] §textbf[EXTENDED] §textbf[ADDRESSING]
...

   ...
   with the following message:
        ...
        %LNKFTH Fullword value §lbrack[]symbol§rbrack[] truncated to halfword
   ...
   §textbf[Table] §textbf[1-1:]  §textbf[Summary] §textbf[of] §textbf[LINK] §textbf[Switches]


   +--------------------------------------------------------------------+
   |                                                                    |
   | §textbf[Switch]         §textbf[Description]                                         |
   +--------------------------------------------------------------------+
   |                                                                    |
...

                                 ...
                                 §textbf[CHAPTER] §textbf[2]

                          §textbf[USING] §textbf[LINK] §textbf[AUTOMATICALLY]
   ...
   the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].

   Each of these commands invoke LINK:

         o  The §textbf[LOAD] command uses LINK to load your object  modules  into
            memory.   LOAD  compiles source files first if necessary, but
            does not execute the program.

         o  The §textbf[EXECUTE] command uses LINK to load your program, and  then
            executes  the  loaded  program.   Before loading, your source
            files are compiled, if necessary.

         o  The §textbf[DEBUG] command loads your program into memory along with a
            ...
            in the §uline[TOPS-20] §uline[Commands] §uline[Reference] §uline[Manual].



   §textbf[2.1]  §textbf[COMMAND] §textbf[FORMATS]
...

   ...
   §textbf[2.2]  §textbf[COMMAND] §textbf[SWITCHES]
   ...
   the command switches  that  apply  to  LINK.   Refer  to  the  §uline[TOPS-20]
   §uline[Commands]  §uline[Reference]  §uline[Manual]  for complete descriptions of the switches
   for these commands.


   §textbf[Table] §textbf[2-1:]  §textbf[Switches] §textbf[for] §textbf[TOPS-20] §textbf[Commands]


   +-------------------------------------------------------------------+
   |                                                                   |
   | §textbf[Switch]       §textbf[Meaning]                                              |
   +-------------------------------------------------------------------+
...

   ...
   §textbf[2.3]  §textbf[EXAMPLE] §textbf[OF] §textbf[USING] §textbf[LINK] §textbf[AUTOMATICALLY]
   ...
   using the EXECUTE command:
        ...
        MAIN.  
        LINK: Loading
        §lbrack[]LNKXCT MYPROG execution§rbrack[]
...

                                 ...
                                 §textbf[CHAPTER] §textbf[3]

                            §textbf[USING] §textbf[LINK] §textbf[DIRECTLY]
   ...
   §textbf[3.1]  §textbf[RUNNING] §textbf[AND] §textbf[EXITING] §textbf[LINK]
...

   ...
   §textbf[3.2]  §textbf[COMMAND] §textbf[FORMATS]
...

   ...
   §textbf[3.2.1]  §textbf[LINK] §textbf[File] §textbf[Specification] §textbf[Defaults]
...

   ...
   §textbf[3.2.2]  §textbf[Logical] §textbf[Names]
   ...
   See the §uline[TOPS-20] §uline[User's] §uline[Guide] for more information.



   §textbf[3.2.3]  §textbf[Translating] §textbf[Directories]
   ...
   To find a corresponding PPN:
        ...
        2.  Include the PPN enclosed in square brackets (§lbrack[]§rbrack[]) at  the  end
            of the file specification in the format:

                 device:filename.type§lbrack[]PPN§rbrack[]



   §textbf[3.3]  §textbf[LINK] §textbf[SWITCHES]
   ...
   §textbf[3.3.1]  §textbf[Switch] §textbf[Abbreviation]
...

   ...
   §textbf[3.3.2]  §textbf[Switch] §textbf[Arguments]
...

   ...
   §textbf[3.3.3]  §textbf[Switch] §textbf[Placement]
...

   ...
   §textbf[3.3.4]  §textbf[Alphabetical] §textbf[Listing] §textbf[of] §textbf[LINK] §textbf[Switches]
...

   ...
   FUNCTION    specifies the symbol types to be included in the map  file
               ...
               §textbf[bold]:
                    ...
                    §textbf[ABSOLUTE]       §textbf[Include] §textbf[absolute] §textbf[symbols.]
                    ALL            Include all symbols.
                    §textbf[COMMON]         §textbf[Include] §textbf[COMMON] §textbf[symbols.]
                    DEFAULT        Reset to LINK's defaults.
                    §textbf[ENTRY]          §textbf[Include] §textbf[entry-name] §textbf[symbols.]
                    §textbf[GLOBAL]         §textbf[Include] §textbf[global] §textbf[symbols.]
                    ...
                    §textbf[NOLOCAL]        §textbf[Exclude] §textbf[local] §textbf[symbols.]
                    NONE           Exclude all symbols.
                    NORELOCATABLE  Exclude relocatable symbols.
                    §textbf[NOUNDEFINED]    §textbf[Exclude] §textbf[undefined] §textbf[symbols.]
                    §textbf[NOZERO]         §textbf[Exclude]   §textbf[symbols]    §textbf[in]    §textbf[zero-length]
                                   §textbf[programs.]    (a   zero-length  program
                                   contains no code or data; it  contains
                                   only  symbol definitions, for example,
                                   JOBDAT.)
                    §textbf[RELOCATABLE]    §textbf[Include] §textbf[relocatable] §textbf[symbols.]
...

   ...
   EXAMPLES    The following examples illustrate  the  various  /COUNTERS
               ...
               @LINK<RET>
               */COUNTERS<RET>
               §lbrack[]LNKRLC No relocation counters set§rbrack[]
...

               ...
               @LINK<RET>
               *ABCODE/COUNTERS<RET>
               §lbrack[]LNKRLC No relocation counters set
                Absolute code loaded§rbrack[]
               *
               ...
               *PSCODE/COUNTERS<RET>
               ...
               §lbrack[]LNKRLC Reloc. ctr.     initial value   current value   limit value
                       PSCODE          20              25              1000000§rbrack[]
               *
               ...
               *TWOPRT/COUNTERS<RET>
               §lbrack[]LNKRLC Reloc. ctr.     initial value   current value   limit value
                       .LOW.           0               1642            1000000
                       .HIGH.          400000          400753          1000000§rbrack[]
               *
...

   ...
   FUNCTION    Specifies a default debugger to be loaded if the /DEBUG or
               ...
               below.  Only those shown in §textbf[bold] are supported by DIGITAL.

                    Keyword     Debugger

                    §textbf[ALGDDT]      §textbf[ALGDDT]
                    §textbf[ALGOL]       §textbf[ALGDDT]
                    §textbf[COBDDT]      §textbf[COBDDT]
                    §textbf[COBOL]       §textbf[COBDDT]
                    §textbf[DDT]         §textbf[DDT]
                    FAIL        SDDT (SAIL debugger)
                    §textbf[FORDDT]      §textbf[FORDDT]
                    §textbf[FORTRAN]     §textbf[FORDDT]
                    §textbf[MACRO]       §textbf[DDT]
                    PASCAL      PASDDT
                    PASDDT      PASDDT
...

   ...
   FUNCTION    Requests loading of a debugger and sets the start  address
               ...
               Only those shown in §textbf[bold] supported by DIGITAL.
...

   ...
   EXAMPLES    */UNDEFINED<RET>
               §lbrack[]LNKUGS  2 UNDEFINED GLOBAL SYMBOLS§rbrack[]
                    ALPHA   400123
                    BETA    402017
...

   ...
   EXAMPLES    @LINK<RET>
               §textbf[/]ENTRY<RET>
               §lbrack[]LNKLSS  LIBRARY SEARCH SYMBOLS (ENTRY POINTS)§rbrack[]
                    SQRT.  3456
               *
...

   ...
   FUNCTION    Gives a minimum for the initial size of the global  symbol
               ...
               If LINK gives the message §lbrack[]LNKRGS  Rehashing Global Symbol
               Table§rbrack[]  during a load, you should use the /HASHSIZE switch
...

               ...
               */COUNTERS<RET>
               §lbrack[]LNKRLC Reloc. ctr.     initial value   current value   limit value
                       .LOW.           0               140             1000000
                       BIG             1000            6300            5400
                       GRAND           5400            10500           1000000§rbrack[]
                       Absolute code loaded§rbrack[]
...

   ...
   EXAMPLES    In  all  the  following  examples,   an   incorrect   file
               ...
               *KSD:MISTKE<RET>
               ...
               §lbrack[] Please retype the incorrect parts of the file
               specification §rbrack[]
               *
...

               ...
               *KSD:MISTKE<RET>
               ...
               §lbrack[] Please retype the incorrect parts of the file specification§rbrack[]
...

   ...
   EXAMPLES    In  the  following  example,  MYPROG  is  loaded,  library
               ...
               */MISSING<RET>
               §lbrack[]LNKIMM  1 included module missing§rbrack[]
               ...
               */MISSING<RET>
               §lbrack[]LNKIMM  no included modules missing§rbrack[]
               *
...

   ...
   EXAMPLES    @LINK<RET>
               */REQUEST<RET>
               §lbrack[]LNKRER  REQUEST EXTERNAL REFERENCES§rbrack[]
                    ROUTN.
                    SQRT.
...

   ...
   EXAMPLES    @LINK<RET>
               §textbf[M]AIN1,/NOSTART MAIN2,MAIN3<RET>
               *
...

   ...
   FUNCTION    Prevents automatic search of the system libraries named as
               ...
               below.    Only  those  shown  in  §textbf[bold]  specify  libraries
               supported by DIGITAL.

                    Keyword     Library

                    §textbf[ANY]         §textbf[all]
                    §textbf[ALGOL]       §textbf[ALGLIB]
                    BCPL        BCPLIB
                    §textbf[COBOL]       §textbf[LIBOL] §textbf[or] §textbf[C74LIB]
                    §textbf[FORTRAN]     §textbf[FORLIB]
                    NELIAC      LIBNEL
                    PASCAL      PASLIB
                    SAIL        SAILIB
                    SIMULA      SIMLIB
...

   ...
   FUNCTION    Specifies the time and manner of loading  the  object-time
               ...
               execution  time, except in the following cases.  If §textbf[any] of
...

   ...
   FUNCTION    Initiates construction of an  overlay  structure.   For  a
               ...
               default settings are shown in §textbf[bold]

                    Keyword           Description

                    §textbf[ABSOLUTE]          §textbf[Specifies] §textbf[that] §textbf[links] §textbf[are] §textbf[absolute.]
                    ...
                    §textbf[NOLOGFILE]         §textbf[Suppresses]   §textbf[output]   §textbf[of]    §textbf[runtime]
                                      §textbf[overlay] §textbf[messages.]
                    ...
                    §textbf[TREE]              §textbf[Specifies] §textbf[that] §textbf[the]  §textbf[overlay]  §textbf[has]  §textbf[a]
                                      §textbf[tree] §textbf[structure.]

                    §textbf[WARNING]           §textbf[Outputs] §textbf[overlay] §textbf[warning] §textbf[messages] §textbf[to]
                                      §textbf[user] §textbf[terminal.]
   ...
   EXAMPLES    In the following example, a PDV name  and  version  number
               ...
               *PVTEST/GO<RET>
               ...
               @INFO VERSION<RET>
                      ...
                      .
               Program is PVBLCK
               PDVs: Program name TST@ §textbf[,] version 1.1(3)
               @
...

   ...
   EXAMPLES    The  following  example  loads   a   two-segment   program
               ...
               *TWOPRT<RET>
               */COUNTERS<RET>
               §lbrack[]LNKRLC   Reloc. ctr.    initial value current value limit
               value
                    .LOW.          0     1642  1000000
                    .HIGH.         400000  400753  1000000§rbrack[]
               *
...

   ...
   EXAMPLES    @LINK<RET>
               */UNDEFINED<RET>
               §lbrack[]LNKUGS  NO UNDEFINED GLOBAL SYMBOLS§rbrack[]
...

   ...
   EXAMPLES    In the following example, the ENTPTR  symbol  is  used  in
               ...
               *TEST<RET>
               */VALUE:ENTPTR<RET>
               §lbrack[]LNKVAL   Symbol ENTPTR 140 defined§rbrack[]
               ...
               */SUPPRESS:ENTPTR<RET>
               */VALUE:ENTPTR<RET>
               §lbrack[]LNKVAL   Symbol ENTPTR 0 undefined§rbrack[]

               Finally TEST2 is loaded and the value is shown again.

               *TEST2<RET>
               */VALUE:ENTPTR<RET>
               §lbrack[]LNKVAL   Symbol ENTPTR 200 defined§rbrack[]
...

   ...
   FUNCTION    Forces  searching  of  one  or   more   system   libraries
               ...
               The keywords and the libraries  they  specify  are  listed
               below.    Keywords   shown   in  §textbf[bold]  indicate  libraries
               supported by DIGITAL.
...

   ...
   FUNCTION    Loads the  debugger  indicated  by  keyword.   Unlike  the
               ...
               The keywords and the programs they load are listed  below.
               Only those shown in §textbf[bold] are supported by DIGITAL.
...

   ...
   FUNCTION    Directs LINK to search the user library given in the  file
               ...
               shown in §textbf[bold] are supported by DIGITAL.

                    Keyword           Library

                    §textbf[ALGOL]             §textbf[ALGOL]
                    §textbf[ANY]               §textbf[This] §textbf[library]
                    BCPL              BCPL
                    §textbf[COBOL]             §textbf[COBOL]
                    §textbf[FORTRAN]           §textbf[FORTRAN]
                    NELIAC            NELIAC
                    PASCAL            PASCAL
                    SAIL              SAIL
                    SIMULA            SIMULA
...

   ...
   EXAMPLES    @LINK<RET>
               ...
               */VALUE:(SPEX2,DPEXP,X2,X)<RET>
               §lbrack[]LNKVAL  SPEX2    460    DEFINED§rbrack[]
               §lbrack[]LNKVAL  DPEXP    221    UNDEFINED§rbrack[]
               §lbrack[]LNKVAL  X2       324    COMMON, LENGTH 1 (DECIMAL)§rbrack[]
               §lbrack[]LNKVAL  X        UNKNOWN§rbrack[]
               *
...

   ...
   §textbf[3.5]  §textbf[EXAMPLES] §textbf[USING] §textbf[LINK] §textbf[DIRECTLY]
...

                                 ...
                                 §textbf[CHAPTER] §textbf[4]

                              §textbf[OUTPUT] §textbf[FROM] §textbf[LINK]
   ...
   §textbf[4.1]  §textbf[THE] §textbf[EXECUTABLE] §textbf[PROGRAM]
...

   ...
   §textbf[4.2]  §textbf[OUTPUT] §textbf[FILES]
   ...
   §textbf[4.2.1]  §textbf[Sharable] §textbf[Save] §textbf[Files]
   ...
   §textbf[4.2.1.1]  §textbf[Format] §textbf[of] §textbf[Sharable]  §textbf[Save]  §textbf[Files] - A  sharable  save  file  is
...

   ...
   SFRKV%  JSYS in the §uline[TOPS-20] §uline[Monitor] §uline[Calls] §uline[Reference] §uline[Manual] for further
   information.)
...

   ...
   §textbf[4.2.2]  §textbf[LOG] §textbf[Files]
...

   ...
   §textbf[4.2.3]  §textbf[Map] §textbf[files]
   ...
   §textbf[4.2.4]  §textbf[Symbol] §textbf[Files]
...

   ...
   §textbf[5.1]  §textbf[OVERLAY] §textbf[STRUCTURES]
...

   ...
   §textbf[Figure] §textbf[5-1:]  §textbf[Example] §textbf[of] §textbf[an] §textbf[Overlay] §textbf[Structure]
   ...
   §textbf[5.1.1]  §textbf[Defining] §textbf[Overlay] §textbf[Structures]
   ...
   §textbf[Table] §textbf[5-1:]  §textbf[Summary] §textbf[of] §textbf[LINK's] §textbf[Overlay-Related] §textbf[Switches]
...

   ...
   §textbf[5.1.2]  §textbf[An] §textbf[Overlay] §textbf[Example]
...

   ...
   §textbf[5.1.2.1]  §textbf[Source] §textbf[Files] - Copies of the FORTRAN source files used in the
...

   ...
   §textbf[5.1.2.2]  §textbf[Source] §textbf[File] §textbf[Compilation] - Source files are compiled using the
   ...
   §textbf[5.1.2.3]  §textbf[Interactive] §textbf[use] §textbf[of] §textbf[LINK] - LINK is run and used to define  and
   execute the overlay.

   @LINK
   §textbf[T]EST/LOG/LOGLEVEL:5
   §textbf[/]ERRORLEVEL:5
...

   ...
   §textbf[T]EST/OVERLAY
   §textbf[T]EST/MAP
   §textbf[L]PT:TEST/PLOT
   §textbf[O]VL0,OVL1/LINK:TEST
   §lbrack[]LNKLMN Loading module OVL0 from file OVL0.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module OVL1 from file OVL1.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module OVRLAY from file SYS:OVRLAY.REL.10§rbrack[]
   §lbrack[]LNKLMN Loading module FORHST from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module FORSHR from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module FORGET from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module FDBDUM from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module KSORT from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module FORMSL from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module FORPSE from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKELN End of link number 0 name TEST§rbrack[]
   §textbf[N]ODE:TEST OVL2/LINK:LEFT
   §lbrack[]LNKLMN Loading module OVL2A from file OVL2.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module OVL2B from file OVL2.REL.1§rbrack[]
   §lbrack[]LNKELN End of link number 1 name LEFT§rbrack[]
   §textbf[/]NODE:LEFT OVL5/LINK:LEFT1
   §lbrack[]LNKLMN Loading module OVL5 from file OVL5.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module CEXP3. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module CDLOG from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module CGLOG from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module CGLOG from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module GATAN. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module GLOG. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module DATAN. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module DEXP. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module DLOG. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module DSIN. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module DFL.4 from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module EXP2. from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module MTHMSG from file SYS:FORLIB.REL.1§rbrack[]
   §lbrack[]LNKELN End of link number 2 name LEFT1§rbrack[]
   §textbf[/]NODE:LEFT OVL6/LINK:LEFT2
   §lbrack[]LNKLMN Loading module OVL6 from file OVL6.REL.1§rbrack[]
   §lbrack[]LNKELN End of link number 3 name LEFT2§rbrack[]
   §textbf[/]NODE:TEST OVL3,OVL4/LINK:RIGHT
   §lbrack[]LNKLMN Loading module OVL3 from file OVL3.REL.1§rbrack[]
   §lbrack[]LNKLMN Loading module OVL4 from file OVL4.REL.1§rbrack[]
   §lbrack[]LNKELN End of link number 4 name RIGHT§rbrack[]
   §textbf[T]EST/SAVE
   §textbf[/]EXECUTE/GO
   §lbrack[]LNKXCT OVL0 execution§rbrack[]
...

   ...
   §textbf[5.1.2.4]  §textbf[TEST.LOG] - LINK generated the following  TEST.LOG  file.   It
...

   ...
   §textbf[5.1.2.5]  §textbf[TEST.MAP] - LINK generated the following  TEST.MAP  file.   It
...

   ...
   OVL4    from DSK:OVL4.REL       created by FORTRAN on 11-Feb-85 at 11:52:34
           ...
           §lbrack[]End of LINK map of     OVL0§rbrack[]



   §textbf[5.1.2.6]  §textbf[Tree]   §textbf[Diagram] - The   tree   diagram   requested   by    the
...

   ...
   §textbf[5.1.2.7]  §textbf[Executable] §textbf[File] - The process  also  produced  an  executable
...

   ...
   §textbf[5.2]  §textbf[WRITABLE] §textbf[OVERLAYS]
   ...
   §textbf[5.2.1]  §textbf[Writable] §textbf[Overlay] §textbf[Syntax]
   ...
   §textbf[5.2.2]  §textbf[Writable] §textbf[Overlay] §textbf[Error] §textbf[Messages]
   ...
   two additional error messages for writable overlays:
        ...
        ?  OVLCWF Cannot write file §lbrack[]filename§rbrack[]:  §lbrack[]reason§rbrack[]

        ?  OVLCUF Cannot update file §lbrack[]filename§rbrack[]:  §lbrack[]reason§rbrack[]
   ...
   §textbf[5.3]  §textbf[RELOCATABLE] §textbf[OVERLAYS]
...

   ...
   §textbf[5.3.1]  §textbf[Relocatable] §textbf[Overlay] §textbf[Syntax]
   ...
   §textbf[5.3.2]  §textbf[Relocatable] §textbf[Overlay] §textbf[Messages]
   ...
   your terminal:
        ...
        %OVLRLL Relocating link §lbrack[]linkname§rbrack[] at §lbrack[]address§rbrack[]



   §textbf[5.4]  §textbf[RESTRICTIONS] §textbf[ON] §textbf[OVERLAYS]
...

   ...
   §textbf[5.4.1]  §textbf[Restrictions] §textbf[on] §textbf[Absolute] §textbf[Overlays]
...

   ...
   §textbf[5.4.2]  §textbf[Restrictions] §textbf[on] §textbf[Relocatable] §textbf[Overlays]
   ...
   §textbf[5.4.3]  §textbf[Restrictions] §textbf[on] §textbf[FORTRAN] §textbf[Overlays]
...

   ...
   §textbf[5.5]  §textbf[SIZE] §textbf[OF] §textbf[OVERLAY] §textbf[PROGRAMS]
   ...
   §textbf[5.6]  §textbf[DEBUGGING] §textbf[OVERLAID] §textbf[PROGRAMS]
   ...
   §textbf[5.7]  §textbf[THE] §textbf[OVERLAY] §textbf[HANDLER]
...

   ...
   the following:
        ...
        *SYS:OVRLAY<RET>
        */VALUE:%OVRLA<RET>
        §lbrack[]LNKVAL Symbol %OVRLA 501000210 defined§rbrack[]
        *
   ...
   §textbf[5.7.1]  §textbf[Calls] §textbf[to] §textbf[the] §textbf[Overlay] §textbf[Handler]
...

   ...
   §textbf[5.7.2]  §textbf[Overlay] §textbf[Handler] §textbf[Subroutines]
...

   ...
   §textbf[MACRO] §textbf[Entry]     §textbf[FORTRAN]                 §textbf[Subroutine]
   §textbf[Name] §textbf[Symbol]   §textbf[Subroutine]                 §textbf[Function]
   ...
   §textbf[Declaring] §textbf[a] §textbf[Non-Writable] §textbf[Link] §textbf[(CLROV.)]
...

   ...
   §textbf[Getting] §textbf[a] §textbf[Specific] §textbf[Path] §textbf[(GETOV.)]
...

   ...
   §textbf[Initializing] §textbf[an] §textbf[Overlay] §textbf[(INIOV.)]
...

   ...
   §textbf[Specifying] §textbf[an] §textbf[Overlay] §textbf[Log] §textbf[File] §textbf[(LOGOV.)]
   ...
   §textbf[Removing] §textbf[Specific] §textbf[Links] §textbf[from] §textbf[Memory] §textbf[(REMOV.)]
...

   ...
   §textbf[Running] §textbf[a] §textbf[Specific] §textbf[Link] §textbf[(RUNOV.)]
...

   ...
   §textbf[Declaring] §textbf[A] §textbf[Writable] §textbf[Link] §textbf[(SAVOV.)]
...

   ...
   §textbf[5.7.3]  §textbf[Overlay] §textbf[Handler] §textbf[Messages]
...

   ...
   §textbf[Code]  §textbf[Sev]                     §textbf[Message] §textbf[and] §textbf[Explanation]

   §textbf[ARC]   §textbf[31]    §textbf[Attempt] §textbf[to] §textbf[remove] §textbf[caller] §textbf[from] §textbf[link] §textbf[§lbrack[]name] §textbf[or] §textbf[number§rbrack[]]
   ...
   §textbf[ARL]    §textbf[8]    §textbf[Ambiguous] §textbf[request] §textbf[in] §textbf[link] §textbf[number]  §textbf[§lbrack[]number§rbrack[]]  §textbf[for]  §textbf[§lbrack[]symbol§rbrack[],]
               §textbf[using] §textbf[link] §textbf[number] §textbf[§lbrack[]number§rbrack[]]
   ...
   §textbf[CDL]   §textbf[31]    §textbf[Cannot] §textbf[delete] §textbf[link] §textbf[§lbrack[]name] §textbf[or] §textbf[number§rbrack[],] §textbf[FUNCT.] §textbf[return]  §textbf[status]
               §textbf[§lbrack[]number§rbrack[]]
   ...
   §textbf[CGM]   §textbf[31]    §textbf[Cannot] §textbf[get] §textbf[memory] §textbf[from] §textbf[OTS,] §textbf[FUNCT.] §textbf[return] §textbf[status] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §textbf[CRF]   §textbf[31]    §textbf[Cannot] §textbf[read] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]

               An error occurred when reading the overlay file.  The file
               was closed after the last successful read operation.

   §textbf[CSM]   §textbf[31]    §textbf[Cannot] §textbf[shrink] §textbf[memory,] §textbf[FUNCT.] §textbf[return] §textbf[status] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §textbf[CUF]   §textbf[31]    §textbf[Cannot] §textbf[update] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]
...

   ...
   §textbf[CWF]   §textbf[31]    §textbf[Cannot] §textbf[write] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]

               An error occurred when creating the TMP file used to store
               non-resident writable overlay links.

   §textbf[DLN]   §textbf[1]     §textbf[Deleting] §textbf[link] §textbf[§lbrack[]name] §textbf[or] §textbf[number§rbrack[]] §textbf[after] §textbf[§lbrack[]hh:mm:ss§rbrack[]]
   ...
   §textbf[IAT]   §textbf[31]    §textbf[Illegal] §textbf[argument] §textbf[type] §textbf[on] §textbf[call] §textbf[to] §textbf[§lbrack[]subroutine§rbrack[]]

               A user call to the named overlay handler  subroutine  gave
               an illegal type of argument.

   §textbf[IEF]   §textbf[31]    §textbf[Input] §textbf[error] §textbf[for] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]

               An error occurred while reading the OVL or TMP file.

   §textbf[ILN]   §textbf[31]    §textbf[Illegal] §textbf[link] §textbf[number] §textbf[§lbrack[]number§rbrack[]]

               A user call to one of the overlay handler subroutines gave
               an illegal link number as an argument.

   §textbf[IMP]   §textbf[31]    §textbf[Impossible] §textbf[error] §textbf[condition] §textbf[at] §textbf[PC=§lbrack[]address§rbrack[]]
   ...
   §textbf[IPE]   §textbf[31]    §textbf[Input] §textbf[positioning] §textbf[error] §textbf[for] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]

               An error occurred while reading the OVL or TMP file.

   §textbf[IVN]   §textbf[8]     §textbf[Inconsistent] §textbf[version] §textbf[numbers]

               The OVL and EXE files found were not created at  the  same
               time, and may not be compatible.

   §textbf[LNM]   §textbf[31]    §textbf[Link] §textbf[number] §textbf[§lbrack[]decimal§rbrack[]] §textbf[not] §textbf[in] §textbf[memory]
...

   ...
   §textbf[MAN]   §textbf[31]    §textbf[Memory] §textbf[not] §textbf[available] §textbf[for]  §textbf[absolute]  §textbf[§lbrack[]link§rbrack[],]  §textbf[FUNCT.] §textbf[return]
               §textbf[status] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §textbf[MEF]   §textbf[31]    §textbf[Memory] §textbf[expansion] §textbf[failed,] §textbf[FUNCT.] §textbf[return] §textbf[status] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §textbf[NMS]   §textbf[8]     §textbf[Not] §textbf[enough] §textbf[memory] §textbf[to] §textbf[load] §textbf[symbols,] §textbf[FUNCT.]   §textbf[return]  §textbf[status]
               §textbf[§lbrack[]octal§rbrack[]]

               There was not enough free space available to load  symbols
               into memory.

   §textbf[NRS]   §textbf[31]    §textbf[No] §textbf[relocation] §textbf[table] §textbf[for] §textbf[symbols]
   ...
   §textbf[NSA]   §textbf[31]    §textbf[No] §textbf[start] §textbf[address] §textbf[for] §textbf[link] §textbf[§lbrack[]name] §textbf[or] §textbf[number§rbrack[]]
   ...
   §textbf[NSD]   §textbf[31]    §textbf[No] §textbf[such] §textbf[device] §textbf[for] §textbf[§lbrack[]file§rbrack[]]

               An invalid device was specified.

   §textbf[OEF]   §textbf[31]    §textbf[Output] §textbf[error] §textbf[for] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]

               An error occurred when writing the overlay file.  The file
               was closed after the last successful write operation.

   §textbf[OPE]   §textbf[31]    §textbf[Output] §textbf[positioning] §textbf[error] §textbf[for] §textbf[file] §textbf[§lbrack[]file§rbrack[]] §textbf[§lbrack[]reason§rbrack[]]

               An error occurred while writing the TMP file used to  hold
               non-resident writable overlay links.

   §textbf[OPP]   §textbf[31]    §textbf[Overlay] §textbf[handler] §textbf[in] §textbf[private] §textbf[page]
...

   ...
   §textbf[RLL]   §textbf[1]     §textbf[Relocating] §textbf[link] §textbf[§lbrack[]name] §textbf[or] §textbf[number§rbrack[]] §textbf[at] §textbf[§lbrack[]address§rbrack[]]

               The named relocatable link has been loaded  at  the  given
               address.   This  message is output only to the overlay log
               file.

   §textbf[RLN]   §textbf[1]     §textbf[Reading] §textbf[in] §textbf[link] §textbf[§lbrack[]name] §textbf[or] §textbf[number§rbrack[]] §textbf[after] §textbf[§lbrack[]time§rbrack[]]
   ...
   §textbf[RMP]   §textbf[31]    §textbf[RMAP] §textbf[JSYS] §textbf[failed]

               This is an internal error and is not  expected  to  occur.
               If it does, please notify your Software Specialist or send
               a Software Performance Report (SPR) to DIGITAL.

   §textbf[RPA]   §textbf[31]    §textbf[RPACS] §textbf[JSYS] §textbf[failed]

               This is an internal error and is not  expected  to  occur.
               If it does, please notify your Software Specialist or send
               a Software Performance Report (SPR) to DIGITAL.

   §textbf[STS]   §textbf[8]     §textbf[OTS] §textbf[reserved] §textbf[space] §textbf[too] §textbf[small]
   ...
   §textbf[ULN]   §textbf[31]    §textbf[Unknown] §textbf[link] §textbf[name] §textbf[§lbrack[]name§rbrack[]]

               A call to one of the overlay handler subroutines  gave  an
               invalid link name as an argument.  Correct the call.

   §textbf[USC]   §textbf[8]     §textbf[Undefined] §textbf[subroutine] §textbf[§lbrack[]name§rbrack[]] §textbf[called] §textbf[from] §textbf[§lbrack[]address§rbrack[]]
   ...
   §textbf[WLN]   §textbf[1]     §textbf[Writing] §textbf[§lbrack[]link§rbrack[]] §textbf[after] §textbf[§lbrack[]time§rbrack[]]
...

   ...
   §textbf[5.7.4]  §textbf[The] §textbf[FUNCT.] §textbf[Subroutine]
   ...
   system (after ?, %, or §lbrack[]); and status (on return) contains one of  the
   following values:
   ...
   are:
        ...
        §textbf[Code]   §textbf[Name]             §textbf[Function]
...

   ...
   §textbf[COR] §textbf[(2)]  §textbf[Function]
   ...
   §textbf[RAD] §textbf[(3)]  §textbf[Function]
   ...
   §textbf[GCH] §textbf[(4)]  §textbf[Function]

   Returns a status of 1.  The channel is not available.


   §textbf[RCH] §textbf[(5)]  §textbf[Function]
...

   ...
   §textbf[GOT] §textbf[(6)]  §textbf[Function]
   ...
   §textbf[ROT] §textbf[(7)]  §textbf[Function]
...

   ...
   §textbf[RNT] §textbf[(10)]  §textbf[Function]
   ...
   §textbf[IFS] §textbf[(11)]  §textbf[Function]

   Always returns a value of -1.  This function is not implemented.


   §textbf[CBC] §textbf[(12)]  §textbf[Function]
   ...
   §textbf[RRS] §textbf[(13)] §textbf[Function] ( Reserved for DBMS )

   Returns ARG1 = 0.  On return, the status is always 0.


   §textbf[WRS] §textbf[(14)] §textbf[Function] ( Reserved for DBMS )

   Returns ARG1 = 0.  On return, the status is always 0.


   §textbf[GPG] §textbf[(15)] §textbf[Function]
   ...
   §textbf[RPG] §textbf[(16)] §textbf[Function]
...

   ...
   §textbf[RPSI] §textbf[(20)] §textbf[Function]
...

   ...
   §textbf[5.8]  §textbf[THE] §textbf[OVERLAY] §textbf[(OVL)] §textbf[FILE]
   ...
   diagram shows the overall scheme of the file:
                      ...
                      §textbf[Scheme] §textbf[of] §textbf[the] §textbf[Overlay] §textbf[(OVL)] §textbf[File]
...

   ...
   §textbf[5.8.1]  §textbf[The] §textbf[Directory] §textbf[Block]

   The following diagram shows the contents of the Directory Block:


                              §textbf[Directory] §textbf[Block]
...

   ...
   §textbf[5.8.2]  §textbf[The] §textbf[Link] §textbf[Number] §textbf[Table]

   The following diagram shows the contents of the Link Number Table:


                             §textbf[Link] §textbf[Number] §textbf[Table]
   ...
   §textbf[5.8.3]  §textbf[The] §textbf[Link] §textbf[Name] §textbf[Table]

   The following diagram shows the contents of the Link Name Table:


                              §textbf[Link] §textbf[Name] §textbf[Table]
...

   ...
   §textbf[5.8.4]  §textbf[The] §textbf[Overlay] §textbf[Link]

   The following diagram shows the overall scheme of each overlay link in
   the overlay file:


                         §textbf[Scheme] §textbf[of] §textbf[an] §textbf[Overlay] §textbf[Link]
...

   ...
   §textbf[Code] §textbf[for] §textbf[the] §textbf[Link]
   ...
   §textbf[The] §textbf[Control] §textbf[Section]

   The following diagram shows the contents of the Control Section:


                              §textbf[Control] §textbf[Section]
...

   ...
   §textbf[The] §textbf[EXTTAB] §textbf[Table]
...

   ...
   §textbf[The] §textbf[INTTAB] §textbf[Table]
...

   ...
   §textbf[The] §textbf[Relocation] §textbf[Table]

   The following diagram shows the contents of the Relocation Table:


                              §textbf[Relocation] §textbf[Table]
...

   ...
   §textbf[The] §textbf[Other] §textbf[Relocation] §textbf[Tables]

   The following diagram shows  the  contents  of  the  Other  Relocation
   Tables:


                          §textbf[Other] §textbf[Relocation] §textbf[Tables]
...

   ...
   §textbf[6.1]  §textbf[LOADING] §textbf[PROGRAMS] §textbf[WITH] §textbf[PSECTs]
   ...
   load code.  The warning is:
        ...
        %LNKPEL PSECT §lbrack[]psect§rbrack[] exceeded limit of §lbrack[]address§rbrack[]

   Although LINK does continue to process input files and load code,  the
   program  is  incomplete and should §uline[not] be used.  LINK does produce the
...

   ...
   %LNKPOV Psects §lbrack[]psect§rbrack[] and §lbrack[]psect§rbrack[] overlap from address  §lbrack[]address§rbrack[]  to
   §lbrack[]address§rbrack[]
   ...
   */COUNTERS<RET>
   §lbrack[]LNKRLC Reloc. ctr.    initial value  current value  limit value
           .LOW.          0              140            1000000
           BIG            1000           5100           1000000
           GRAND          7000           10500          1000000§rbrack[]
   ...
   */GO<RET>
   ...
   §textbf[6.2]  §textbf[PSECT] §textbf[ATTRIBUTES]
...

   ...
   §textbf[6.2.1]  §textbf[CONCATENATED] §textbf[and] §textbf[OVERLAID]
   ...
   */COUNTERS<RET>
   §lbrack[]LNKRLC Reloc. ctr.    initial value  current value  limit value
           ...
           GAMMA          7000           7025           1000000§rbrack[]
...

   ...
   */COUNTERS<RET>
   §lbrack[]LNKRLC Reloc. ctr.    initial value  current value  limit value
           ALPHA          3000           3033           1000000
           BETA           5000           5041           1000000
           GAMMA          7000           7035           1000000§rbrack[]
   */GO<RET>
   @



   §textbf[6.2.2]  §textbf[RONLY] §textbf[and] §textbf[RWRITE]
...

   ...
   For more information about the  PDVOP%  JSYS,  refer  to  the  §uline[TOPS-20]
...

   ...
   §textbf[7.1]  §textbf[PDV] §textbf[FORMAT]
...

   ...
   §textbf[7.2]  §textbf[THE] §textbf[PDV] §textbf[STATIC] §textbf[MEMORY] §textbf[MAP]
...

   ...
   §textbf[7.3]  §textbf[SYMBOL] §textbf[TABLE] §textbf[VECTOR]
...

                                 ...
                                 §textbf[APPENDIX] §textbf[A]

                                 §textbf[REL] §textbf[BLOCKS]
   ...
   §textbf[Header] §textbf[Word:]        a fullword that contains the REL Block Type in its
                       left  half  and a short count or long count in its
                       right half.

   §textbf[Short] §textbf[Count:]        a halfword that contains the  length  of  the  REL
   ...
   §textbf[Long] §textbf[Count:]         a halfword that contains the  length  of  the  REL
                       Block, including all words in the block except the
                       header word itself.

   §textbf[Relocation] §textbf[Word:]    a fullword that contains the relocation  bits  for
...

   ...
   §textbf[Data] §textbf[Word:]          Any word other than a header word or a  relocation
                       word.

   §textbf[MBZ:]                Must Be Zero.
...

   ...
   for customers:
               ...
               §textbf[Type] §textbf[Numbers]                      §textbf[Use]
...

                          ...
                          §textbf[Block] §textbf[Type] §textbf[0] §textbf[(Ignored)]
...

                            ...
                            §textbf[Block] §textbf[Type] §textbf[1] §textbf[(Code)]
...

                          ...
                          §textbf[Block] §textbf[Type] §textbf[2] §textbf[(Symbols)]
   ...
   are:
     ...
     §textbf[Code]                          §textbf[Meaning]

     §textbf[00]   This code is illegal in a symbol block.

     §textbf[04]   The given symbol is a global definition.  Its value,  contained
          in the second word of the pair, is available to other programs.

     §textbf[10]   The given symbol is  a  local  definition,  and  its  value  is
     ...
     §textbf[14]   The given symbol is a block name (from a translator  that  uses
     ...
     §textbf[24]   The given symbol is a global definition.  However, it  is  only
...

     ...
     §textbf[30]   The given symbol is a global definition.  However, it  is  only
          partially  defined  at  this  time, and LINK cannot yet use its
          value.  If the symbol is defined in terms  of  another  symbol,
          then  the  next  entry in the REL file must be a word pair in a
          Block Type 2 as follows:
     ...
     §textbf[34]   The given symbol is a global definition.  However, it  is  only
          partially  defined  at  this  time, and LINK cannot yet use its
          value.  If the symbol is defined in terms  of  another  symbol,
          then  the  next  entry in the REL file must be a word pair in a
          Block Type 2 as follows:
...

     ...
     §textbf[44]   The given symbol is a global definition exactly as in code  04,
          except that DDT does not output the symbol.

     §textbf[50]   The given symbol is a local  symbol  exactly  as  in  code  10,
          except that DDT does not output the symbol.

     §textbf[60]   The given symbol is a global request.  LINK's handling  of  the
     ...
     §textbf[64]   The given symbol is a global definition exactly as in code  24,
          except that DDT does not output the symbol.

     §textbf[70]   The given symbol is partially defined, where the left  half  is
          deferred,  as  in  code 30, except that DDT does not output the
          symbol.

     §textbf[74]   The given symbol is partially defined, where the right half  is
...

   ...
   block must occur in the symbol table §textbf[in] §textbf[the] §textbf[order] §textbf[of] §textbf[the] §textbf[block] §textbf[endings]
   in the program.
...

                           ...
                           §textbf[Block] §textbf[Type] §textbf[3] §textbf[(HISEG)]
...

                           ...
                           §textbf[Block] §textbf[Type] §textbf[4] §textbf[(Entry)]
...

                            ...
                            §textbf[Block] §textbf[Type] §textbf[5] §textbf[(End)]
...

                            ...
                            §textbf[Block] §textbf[Type] §textbf[6] §textbf[(Name)]
...

                           ...
                           §textbf[Block] §textbf[Type] §textbf[7] §textbf[(Start)]
...

                     ...
                     §textbf[Block] §textbf[Type] §textbf[10] §textbf[(Internal] §textbf[Request)]
...

                          ...
                          §textbf[Block] §textbf[Type] §textbf[11] §textbf[(Polish)]
...

   ...
   §textbf[.LINK] §textbf[fixup] §textbf[codes]
   ...
   §textbf[Symbol] §textbf[Fixup] §textbf[Store] §textbf[Operator] §textbf[Codes]:
   ...
   §textbf[Chained] §textbf[Fixup] §textbf[Store] §textbf[Operator] §textbf[Codes]:
   ...
   §textbf[Data] §textbf[Type] §textbf[Codes]:
...

   ...
   §textbf[Arithmetic] §textbf[and] §textbf[Logical] §textbf[Operator] §textbf[Codes]:
        ...
        15   Count leading zeros (like JFFO instruction).  Refer  to  the
             §uline[MACRO]  §uline[Assembler]  §uline[Reference] §uline[Manual] for information about the
...

   ...
   §textbf[PSECT] §textbf[Index] §textbf[Codes]:
...

                           ...
                           §textbf[Block] §textbf[Type] §textbf[12] §textbf[(Chain)]
...

                           ...
                           §textbf[Block] §textbf[Type] §textbf[14] §textbf[(Index)]
...

                           ...
                           §textbf[Block] §textbf[Type] §textbf[15] §textbf[(ALGOL)]
   ...
   standard TOPS-10 format below:
        ...
        device:name.type§lbrack[]project-programmer number§rbrack[]
...

                       ...
                       §textbf[Block] §textbf[Type] §textbf[16] §textbf[(Request] §textbf[Load)]
...

                      ...
                      §textbf[Block] §textbf[Type] §textbf[17] §textbf[(Request] §textbf[Library)]
...

                          ...
                          §textbf[Block] §textbf[Type] §textbf[20] §textbf[(Common)]
   ...
   LINK allocates the specified COMMON into the current PSECT  §uline[only]  when
...

                        ...
                        §textbf[Block] §textbf[Type] §textbf[21] §textbf[(Sparse] §textbf[Data)]
...

                       ...
                       §textbf[Block] §textbf[Type] §textbf[22] §textbf[(PSECT] §textbf[Origin)]
...

                      ...
                      §textbf[Block] §textbf[Type] §textbf[23] §textbf[(PSECT] §textbf[End] §textbf[Block)]
...

                    ...
                    §textbf[Block] §textbf[Type] §textbf[24] §textbf[(PSECT] §textbf[Header] §textbf[Block)]
   ...
   fourth word is the PSECT origin specified for this module.
        ...
        §textbf[Bit]       §textbf[Interpretation]                     §textbf[MACRO] §textbf[.PSECT] §textbf[Keyword]
...

                       ...
                       §textbf[Block] §textbf[Type] §textbf[37] §textbf[(COBOL] §textbf[Symbols)]
...

                         ...
                         §textbf[Block] §textbf[Type] §textbf[100] §textbf[(.ASSIGN)]
...

                       ...
                       §textbf[Block] §textbf[Type] §textbf[776] §textbf[(Symbol] §textbf[File)]
...

                      ...
                      §textbf[Block] §textbf[Type] §textbf[777] §textbf[(Universal] §textbf[File)]
...

                         ...
                         §textbf[Block] §textbf[Type] §textbf[1000] §textbf[(Ignored)]
...

                          ...
                          §textbf[Block] §textbf[Type] §textbf[1001] §textbf[(Entry)]
...

                       ...
                       §textbf[Block] §textbf[Type] §textbf[1002] §textbf[(Long] §textbf[Entry)]
...

                       ...
                       §textbf[Block] §textbf[Type] §textbf[1003] §textbf[(Long] §textbf[Title)]
...

   ...
   code.  That is given by the following formula:
        ...
        code =  31§lbrack[]12(year-1964)+(month-1)§rbrack[]+(day-1)
   ...
   See  the  §uline[TOPS-10]  §uline[Monitor]  §uline[Calls]  §uline[Reference]  §uline[Manual]  for   additional
...

                   ...
                   §textbf[Block] §textbf[Type] §textbf[1004] §textbf[(Byte] §textbf[Initialization)]
...

                   ...
                   §textbf[Block] §textbf[Types] §textbf[1010] §textbf[-] §textbf[1037] §textbf[(Code] §textbf[Blocks)]
...

                   ...
                   §textbf[Blocks] §textbf[1010] §textbf[-] §textbf[1017] §textbf[(Right] §textbf[Relocation)]
   ...
   applies to the right half of the corresponding data word.
        ...
        b1,b2...bi          are the relocation bytes.
                            ...
                            §textbf[Size] §textbf[I-value] §textbf[Block] §textbf[Type]
...

           ...
           §textbf[Block] §textbf[Types] §textbf[1020-1027] §textbf[(Left/Right] §textbf[Relocation] §textbf[Blocks)]
...

          ...
          §textbf[Block] §textbf[Types] §textbf[1030] §textbf[-] §textbf[1037] §textbf[(Thirty-bit] §textbf[Relocation] §textbf[Blocks)]
   ...
   word.
        ...
        b1,b2..bi           are the relocation bytes.
                            ...
                            §textbf[Size] §textbf[I-Value]   §textbf[Block] §textbf[Type]     §textbf[Maximum] §textbf[No.]  §textbf[of]
                                                          §textbf[PSECTs]
...

                  ...
                  §textbf[Block] §textbf[Type] §textbf[1042] §textbf[(Request] §textbf[Load] §textbf[for] §textbf[SFDs)]
   ...
   included.  For example, the directory §lbrack[]27,5434,SFD1,SFD2§rbrack[] would have a
...

                ...
                §textbf[Block] §textbf[Type] §textbf[1043] §textbf[(Request] §textbf[Library] §textbf[for] §textbf[SFDs)]
   ...
   For  example, the directory §lbrack[]27,5434,SFD1,SFD2§rbrack[] would have a directory
   count of 3.
...

                      ...
                      §textbf[Block] §textbf[Type] §textbf[1044] §textbf[(ALGOL] §textbf[Symbols)]
...

                     ...
                     §textbf[Block] §textbf[Type] §textbf[1045] §textbf[(Writable] §textbf[Links)]
...

                  ...
                  §textbf[Block] §textbf[Type] §textbf[1050] §textbf[(Long] §textbf[PSECT] §textbf[Name] §textbf[Block)]
...

        ...
        14        CONCATENATE parts of PSECTs seen in distinct modules.
                  ...
                  specified for psect §lbrack[]name§rbrack[].
        ...
        16        This PSECT must be READ-ONLY.
                  ...
                  specified   for  psect  §lbrack[]name§rbrack[].   If  neither  is  set,
...

                    ...
                    §textbf[Block] §textbf[Type] §textbf[1051] §textbf[(Set] §textbf[Current] §textbf[PSECT)]
...

                        ...
                        §textbf[Block] §textbf[Type] §textbf[1052] §textbf[(PSECT] §textbf[End)]
...

                    ...
                    §textbf[Block] §textbf[Type] §textbf[1060] §textbf[(Trace] §textbf[Block] §textbf[Data)]
...

                    ...
                    §textbf[Block] §textbf[Type] §textbf[1070] §textbf[(Long] §textbf[Symbol] §textbf[Names)]
...

   ...
   each word, the field, bits, and description is given.
        ...
        §textbf[Field]               §textbf[Bits]

                                §textbf[Header] §textbf[Word]
...

        ...
        §textbf[Field]                       §textbf[Bits]             §textbf[Description]

                            §textbf[Flag] §textbf[Word] §textbf[(Continued)]
...

   ...
   Name Word                        Contains the symbol name in SIXBIT.
                          ...
                          §textbf[N] §textbf[Additional] §textbf[Name] §textbf[Words]
   ...
   Additional name field            Optional.  It exists only if N  >  0.
                          ...
                          §textbf[V] §textbf[Additional] §textbf[Value] §textbf[Words]
...

                    ...
                    §textbf[Block] §textbf[Type] §textbf[1072] §textbf[(Long] §textbf[Polish] §textbf[Block)]
...

                              ...
                              §textbf[CODE] §textbf[DEFINITIONS]
...

                    ...
                    §textbf[Block] §textbf[Type] §textbf[1074] §textbf[(Long] §textbf[Common] §textbf[Name)]
...

            ...
            §textbf[Block] §textbf[types] §textbf[1120-1127] §textbf[(Argument] §textbf[Descriptor] §textbf[Blocks)]
...

   ...
   is permissible.  Secondary descriptors have the following format:
     ...
     §textbf[Bit] §textbf[Pos]                       §textbf[Usage]
...

                             ...
                             §textbf[Block] §textbf[Type] §textbf[1130] §textbf[(Coercion] §textbf[Block)]
   ...
   The field codes are defined as follows:
        ...
        §textbf[Field] §textbf[Code]               §textbf[Condition]
...

   ...
   select one of the following five possible responses:
        ...
        §textbf[Code] §textbf[(18] §textbf[Bits)]                         §textbf[Action]
...

                ...
                §textbf[Block] §textbf[Type] §textbf[1131] §textbf[(TWOSEG] §textbf[Redirection] §textbf[Block)]
...

                ...
                §textbf[Block] §textbf[Type] §textbf[1140] §textbf[(PL/1] §textbf[debugger] §textbf[information)]
...

        ...
        §textbf[Block] §textbf[Type] §textbf[1160] §textbf[(Extended] §textbf[Sparse] §textbf[Data] §textbf[Initialization] §textbf[Block)]
...

                   ...
                   §textbf[Block] §textbf[Type] §textbf[Greater] §textbf[Than] §textbf[3777] §textbf[(ASCIZ)]
...

                                 ...
                                 §textbf[APPENDIX] §textbf[B]

                               §textbf[LINK] §textbf[MESSAGES]
   ...
   §textbf[B.1]  §textbf[DESCRIPTION] §textbf[OF] §textbf[MESSAGES]

   For each message, the last three letters of  the  6-letter  code,  the
   level,  the severity, and its medium-length message are given in §textbf[bold.]
   The long message follows, and appears beneath the medium message.

        §textbf[CODE]       §textbf[LEV]     §textbf[SEV]     §textbf[MEDIUM] §textbf[MESSAGE]

                                   §textbf[LONG] §textbf[MESSAGE]
   ...
   §textbf[B.1.1]  §textbf[Message] §textbf[Levels]
...

   ...
   §textbf[B.1.2]  §textbf[Message] §textbf[Severity]
   ...
   square  bracket  (§lbrack[]).   Informational  messages  also  end in a square
   bracket (§rbrack[]).  Warnings use percent sign  (%),  and  fatal  errors  use
   question mark (?).



   §textbf[Table] §textbf[B-1:]  §textbf[Severity] §textbf[Codes]


   §textbf[Decimal]       §textbf[Meaning]
   §textbf[Code]       
   ...
   §textbf[B.1.3]  §textbf[Message] §textbf[Length]
...

   ...
   {}             indicate  optional  portions   of   the   medium-length
                  ...
                  message.   Refer to the §uline[TOPS-20] §uline[Monitor] §uline[Calls] §uline[Reference]
                  §uline[Manual] for a description of these messages.

   §lbrack[]§rbrack[]             contain information pertinent to the particular  error.
...

   ...
   §textbf[Table] §textbf[B-2:]  §textbf[Special] §textbf[Message] §textbf[Segments]


   §textbf[Segment]            §textbf[Description]

   §lbrack[]area§rbrack[]             The  name  of  one  of  LINK's   internal   memory
                      management   areas.  See  the  /FRECOR  switch  in
                      Chapter 3 for a list of these areas.

   §lbrack[]date§rbrack[]             The date when LINK is running.

   §lbrack[]decimal§rbrack[]          A decimal number.

   §lbrack[]device§rbrack[]           A device name.

   §lbrack[]file§rbrack[]             A file specification.

   §lbrack[]label§rbrack[]            An internal label in LINK.

   §lbrack[]memory§rbrack[]           A memory size, such as 17P.

   §lbrack[]name§rbrack[]             The  name  of  the  loaded program or a node in an
                      overlaid program.

   §lbrack[]octal§rbrack[]            An octal number.

   §lbrack[]reason§rbrack[]           The reason for a file access failure, one  of  the
                      messages shown in Section B.3.

   §lbrack[]switch§rbrack[]           The name of a switch associated with the error.

   §lbrack[]symbol§rbrack[]           The name of a symbol,  such  as  a  subroutine  or
                      common block name.

   §lbrack[]type§rbrack[]             The type or attribute associated with a symbol.





   §textbf[B.2]  §textbf[LIST] §textbf[OF] §textbf[MESSAGES]


       §textbf[Code]    §textbf[Lev]  §textbf[Sev]                      §textbf[Message]

       §textbf[ABT]     §textbf[31]   §textbf[31]   §textbf[Load]  §textbf[aborted]  §textbf[due]  §textbf[to]  §textbf[%LNKTMA]   §textbf[errors,]   §textbf[max.]
                         §textbf[/ARSIZE:]  §textbf[needed] §textbf[was] §textbf[§lbrack[]decimal§rbrack[]]
...

       ...
       §textbf[AIC]     §textbf[31]   §textbf[31]   §textbf[Attempt]  §textbf[to]  §textbf[increase]  §textbf[size]  §textbf[of]  §textbf[{blank]  §textbf[common}]
                         §textbf[{common] §textbf[§lbrack[]symbol§rbrack[]}] §textbf[from] §textbf[§lbrack[]decimal§rbrack[]] §textbf[to] §textbf[§lbrack[]decimal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[AMM]     §textbf[+]    §textbf[+]    §textbf[Argument] §textbf[mismatch] §textbf[in] §textbf[argument] §textbf[§lbrack[]decimal§rbrack[]] §textbf[in]  §textbf[call]
                         §textbf[to]  §textbf[routine] §textbf[§lbrack[]symbol§rbrack[]] §textbf[called] §textbf[from] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[at] §textbf[location] §textbf[§lbrack[]octal§rbrack[]]

                         The caller supplied argument does not match  the
                         argument expected by the callee.
   §lbrack[]1§rbrack[]

       §textbf[AMP]      §textbf[8]    §textbf[8]   §textbf[ALGOL] §textbf[main] §textbf[program] §textbf[not] §textbf[loaded]
       ...
       §textbf[ANM]     §textbf[31]   §textbf[31]   §textbf[Address] §textbf[not] §textbf[in] §textbf[memory]
       ...
       §textbf[ARL]      §textbf[8]    §textbf[8]   §textbf[Ambiguous]  §textbf[request]  §textbf[in]  §textbf[link]   §textbf[§lbrack[]decimal§rbrack[]]   §textbf[{name]
                         §textbf[§lbrack[]name§rbrack[]}] §textbf[for] §textbf[§lbrack[]symbol§rbrack[]] §textbf[defined] §textbf[in] §textbf[links] §textbf[§lbrack[]decimal§rbrack[],]
                         §textbf[§lbrack[]decimal§rbrack[],] §textbf[...]
   ...
   ---------------
    ...
    §lbrack[]1§rbrack[]  + The level and severity of this  message  is  determined  by  a
...

       ...
       §textbf[AZW]     §textbf[31]   §textbf[31]   §textbf[Allocating] §textbf[zero] §textbf[words]
       ...
       §textbf[CBO]     §textbf[31]   §textbf[31]   §textbf[Cannot] §textbf[build] §textbf[overlays] §textbf[outside] §textbf[section] §textbf[zero]
       ...
       §textbf[CCD]     §textbf[31]   §textbf[31]   §textbf[CPU] §textbf[conflict]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[CCE]      §textbf[8]    §textbf[8]   §textbf[Character] §textbf[constant] §textbf[not] §textbf[word] §textbf[aligned] §textbf[in]  §textbf[call]  §textbf[to]
                         §textbf[routine] §textbf[§lbrack[]routine§rbrack[]] §textbf[called] §textbf[from] §textbf[module] §textbf[§lbrack[]module§rbrack[]] §textbf[at]
...

                         ...
                         §textbf[location] §textbf[§lbrack[]address§rbrack[]]
       ...
       §textbf[CCS]     §textbf[31]   §textbf[31]   §textbf[Cannot] §textbf[create] §textbf[section] §textbf[§lbrack[]octal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[CFS]     §textbf[31]   §textbf[31]   §textbf[Chained] §textbf[fixups] §textbf[have] §textbf[been] §textbf[suppressed]
       ...
       §textbf[CLD]     §textbf[31]   §textbf[28]   §textbf[Cannot] §textbf[load] §textbf[DDT]
                         {JSYS error text}
                         ...
                         why the error occurred.> ;§lbrack[]2304§rbrack[]

       §textbf[CLF]      §textbf[1]    §textbf[1]   §textbf[Closing] §textbf[log] §textbf[file,] §textbf[continuing] §textbf[on] §textbf[file] §textbf[§lbrack[]file§rbrack[]]

                         You have changed  the  log  file  specification.
                         The  old log file is closed; further log entries
                         are written in the new log file.

       §textbf[CMC]     §textbf[31]   §textbf[31]   §textbf[Cannot] §textbf[mix] §textbf[COBOL-68] §textbf[and] §textbf[COBOL-74] §textbf[compiled] §textbf[code]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[CMF]     §textbf[31]   §textbf[31]   §textbf[COBOL] §textbf[module] §textbf[must] §textbf[be] §textbf[loaded] §textbf[first]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
...

       ...
       CMP     31   28   Common §lbrack[]symbol§rbrack[] declared in multiple psects
                         {Detected in module §lbrack[]symbol§rbrack[] from file §lbrack[]file§rbrack[]}
       ...
       §textbf[CNW]     §textbf[31]   §textbf[31]   §textbf[Code] §textbf[not] §textbf[yet] §textbf[written] §textbf[at] §textbf[§lbrack[]label§rbrack[]]
       ...
       §textbf[COE]     §textbf[8]    §textbf[8]    §textbf[Both]   §textbf[CONCATENATE]   §textbf[and]   §textbf[OVERLAY]    §textbf[attributes]
                         §textbf[specified] §textbf[for] §textbf[psect] §textbf[§lbrack[]] §textbf[name] §textbf[§rbrack[]]
       ...
       §textbf[COF]     §textbf[+]    §textbf[+]    §textbf[Cannot] §textbf[open] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         LINK cannot open the specified file for input

       §textbf[CPU]     §textbf[31]   §textbf[31]   §textbf[Module] §textbf[incompatible] §textbf[with] §textbf[specified] §textbf[CPU]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
...

       ...
       §textbf[CRS]      §textbf[1]    §textbf[1]   §textbf[Creating] §textbf[section] §textbf[§lbrack[]octal§rbrack[]]
       ...
       §textbf[CSF]      §textbf[1]    §textbf[1]   §textbf[Creating] §textbf[saved] §textbf[file]

                         LINK is generating your executable (.EXE) file.

       §textbf[CSP]     §textbf[31]   §textbf[28]   §textbf[Cannot] §textbf[setup] §textbf[UDDT] §textbf[symbol] §textbf[table] §textbf[pointers]
                         {JSYS error text}
       ...
       §textbf[DEB]     §textbf[31]    §textbf[1]   §textbf[§lbrack[]name§rbrack[]] §textbf[execution]

                         LINK is beginning program execution at the named
                         debugger.

       §textbf[DLT]     §textbf[31]    §textbf[1]   §textbf[Execution] §textbf[deleted]
       ...
       §textbf[DNA]     §textbf[31]   §textbf[28]   §textbf[DDT] §textbf[not] §textbf[available]
                         {JSYS error text}

                         SYS:UDDT.EXE could not be found.

       §textbf[DRC]      §textbf[8]    §textbf[8]   §textbf[Decreasing]  §textbf[relocation]  §textbf[counter]  §textbf[§lbrack[]symbol§rbrack[]]   §textbf[from]
                         §textbf[§lbrack[]octal§rbrack[]] §textbf[to] §textbf[§lbrack[]octal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[DSC]     §textbf[31]   §textbf[31]   §textbf[Data] §textbf[store] §textbf[to] §textbf[common] §textbf[§lbrack[]symbol§rbrack[]] §textbf[not] §textbf[in] §textbf[link] §textbf[number]
                         §textbf[§lbrack[]decimal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
...

       ...
       §textbf[DSL]     §textbf[31]    §textbf[*]   §textbf[Data] §textbf[store]  §textbf[to]  §textbf[location]  §textbf[§lbrack[]octal§rbrack[]]  §textbf[not]  §textbf[in]  §textbf[link]
                         §textbf[number] §textbf[§lbrack[]decimal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[DUZ]     §textbf[31]   §textbf[31]   §textbf[Decreasing] §textbf[undefined] §textbf[symbol] §textbf[count] §textbf[below] §textbf[zero]
       ...
       §textbf[EAS]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[creating] §textbf[area] §textbf[AS] §textbf[overflow] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[ECE]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[creating] §textbf[EXE] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[EIF]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[for] §textbf[input] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[ELF]      §textbf[1]    §textbf[1]   §textbf[End] §textbf[of] §textbf[log] §textbf[file]
...

       ...
       §textbf[ELN]      §textbf[1]    §textbf[1]   §textbf[End] §textbf[of] §textbf[link] §textbf[number] §textbf[§lbrack[]decimal§rbrack[]] §textbf[{name] §textbf[§lbrack[]name§rbrack[]}]

                         The link is loaded.

       §textbf[ELS]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[creating] §textbf[area] §textbf[LS] §textbf[overflow] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[EMS]      §textbf[1]    §textbf[1]   §textbf[End] §textbf[of] §textbf[MAP] §textbf[segment]

                         The map file is completed and closed.

       §textbf[EOE]     §textbf[31]   §textbf[31]   §textbf[EXE] §textbf[file] §textbf[output] §textbf[error] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         LINK could not write the saved file on the disk.

       §textbf[EOI]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[on] §textbf[input] §textbf[§lbrack[]file§rbrack[]]

                         An error has been  detected  while  reading  the
                         named file.


       §textbf[EOO]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[on] §textbf[output] §textbf[§lbrack[]file§rbrack[]]

                         An error has been  detected  while  writing  the
                         named file.

       §textbf[EOV]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[creating] §textbf[overlay] §textbf[file] §textbf[§lbrack[]reason§rbrack[]] §textbf[§lbrack[]file§rbrack[]]

                         LINK could not write the  overlay  file  on  the
                         disk.

       §textbf[ETP]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[creating] §textbf[area] §textbf[TP] §textbf[overflow] §textbf[file]  §textbf[{§lbrack[]reason§rbrack[]}]
                         §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[EXS]      §textbf[1]    §textbf[1]   §textbf[EXIT] §textbf[segment]
       ...
       §textbf[FCF]      §textbf[1]    §textbf[1]   §textbf[Final] §textbf[code] §textbf[fixups]
...

       ...
       §textbf[FEE]     §textbf[*]    §textbf[*]    §textbf[ENTER] §textbf[error] §textbf[(octal)] §textbf[§lbrack[]reason§rbrack[]] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[FIN]      §textbf[1]    §textbf[1]   §textbf[LINK] §textbf[finished]

                         LINK is finished.   Control  is  passed  to  the
                         monitor, or to the loaded program for execution.

       §textbf[FLE]     §textbf[*]    §textbf[*]    §textbf[LOOKUP] §textbf[error] §textbf[(octal)] §textbf[§lbrack[]reason§rbrack[]] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[FRE]     §textbf[*]    §textbf[*]    §textbf[RENAME] §textbf[error] §textbf[§lbrack[]reason§rbrack[]] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[FSN]     §textbf[31]   §textbf[31]   §textbf[FUNCT.]  §textbf[subroutine] §textbf[not] §textbf[loaded]
...

       ...
       §textbf[FTH]     §textbf[15]   §textbf[15]   §textbf[Fullword] §textbf[value] §textbf[§lbrack[]symbol§rbrack[]] §textbf[truncated] §textbf[to] §textbf[halfword]
       ...
       §textbf[HCL]     §textbf[31]   §textbf[31]   §textbf[High] §textbf[segment] §textbf[code] §textbf[not] §textbf[allowed] §textbf[in] §textbf[an] §textbf[overlay] §textbf[link]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[HSL]     §textbf[31]   §textbf[31]   §textbf[Attempt] §textbf[to] §textbf[set] §textbf[high] §textbf[segment] §textbf[origin] §textbf[too] §textbf[low]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[HTL]     §textbf[31]   §textbf[31]   §textbf[Symbol] §textbf[hash] §textbf[table] §textbf[too] §textbf[large]
       ...
       §textbf[IAS]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[reading] §textbf[area] §textbf[AS] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An error occurred while  reading  in  the  ALGOL
                         symbol table.

       §textbf[ICB]      §textbf[8]    §textbf[8]   §textbf[Invalid] §textbf[chain] §textbf[REL] §textbf[block] §textbf[(type]  §textbf[12)]  §textbf[link]  §textbf[number]
                         §textbf[§lbrack[]octal§rbrack[]]
...

       ...
       §textbf[IDM]     §textbf[31]   §textbf[31]   §textbf[Illegal] §textbf[data] §textbf[mode] §textbf[for] §textbf[device] §textbf[§lbrack[]device§rbrack[]]

                         You specified an illegal combination  of  device
                         and  data  mode  (for example, terminal and dump
                         mode).  Specify a legal device.

       §textbf[IHC]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[reading] §textbf[area] §textbf[HC]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[ILC]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[reading] §textbf[area] §textbf[LC]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An  error  occurred  while   reading   in   your
                         low-segment code.

       §textbf[ILS]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[reading] §textbf[area] §textbf[LS] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An error occurred while reading  in  your  local
                         symbol table.

       §textbf[IMA]      §textbf[8]    §textbf[8]   §textbf[Incremental] §textbf[maps] §textbf[not] §textbf[yet] §textbf[available]

                         The INCREMENTAL keyword for the /MAP  switch  is
                         not implemented.  The switch is ignored.

       §textbf[IMI]     §textbf[31]   §textbf[31]   §textbf[Insufficient] §textbf[memory] §textbf[to] §textbf[initialize] §textbf[LINK]

                         LINK needs more memory than is available.

       §textbf[IMM]      §textbf[*]    §textbf[1]   §textbf[§lbrack[]Decimal§rbrack[]] §textbf[included] §textbf[modules]  §textbf[missing]  §textbf[{from]  §textbf[file]
                         §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[INS]     §textbf[31]   §textbf[31]   §textbf[I/O] §textbf[data] §textbf[block] §textbf[not] §textbf[set]
...

       ...
       §textbf[IOV]     §textbf[31]   §textbf[31]   §textbf[Input] §textbf[error] §textbf[for] §textbf[overlay] §textbf[file] §textbf[§lbrack[]file§rbrack[]]

                         An error occurred when reading the overlay file.

       §textbf[IPO]     §textbf[31]   §textbf[31]   §textbf[Invalid] §textbf[Polish] §textbf[operator] §textbf[§lbrack[]octal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[IPX]     §textbf[31]   §textbf[31]   §textbf[Invalid] §textbf[PSECT] §textbf[index] §textbf[{for] §textbf[PSECT] §textbf[§lbrack[]symbol§rbrack[]}]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[IRB]     §textbf[31]   §textbf[31]   §textbf[Illegal] §textbf[REL] §textbf[block] §textbf[type] §textbf[§lbrack[]octal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[IRC]     §textbf[31]   §textbf[31]   §textbf[Illegal] §textbf[relocation] §textbf[counter]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[IRR]      §textbf[8]    §textbf[8]   §textbf[Illegal] §textbf[request/require] §textbf[block]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
...

       ...
       §textbf[ISM]     §textbf[31]   §textbf[31]   §textbf[Incomplete] §textbf[symbol] §textbf[in] §textbf[store]  §textbf[operator]  §textbf[in]  §textbf[Polish]
                         §textbf[block] §textbf[(type] §textbf[11] §textbf[or] §textbf[1072)]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[ISN]     §textbf[31]   §textbf[31]   §textbf[Illegal] §textbf[symbol] §textbf[name] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[ISP]     §textbf[31]   §textbf[31]   §textbf[Incorrect] §textbf[symbol] §textbf[pointer]
       ...
       §textbf[ISS]      §textbf[8]    §textbf[8]   §textbf[Insufficient] §textbf[space] §textbf[for] §textbf[symbol] §textbf[table] §textbf[after]  §textbf[PSECT]
                         §textbf[§lbrack[]symbol§rbrack[]] §textbf[--] §textbf[table] §textbf[truncated]
       ...
       §textbf[IST]     §textbf[31]   §textbf[31]   §textbf[Inconsistency] §textbf[in] §textbf[switch] §textbf[table]
...

       ...
       §textbf[ITB]     §textbf[31]   §textbf[31]   §textbf[Invalid] §textbf[text] §textbf[in] §textbf[ASCII] §textbf[block] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[ITP]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[reading] §textbf[area] §textbf[TP] §textbf[{Status] §textbf[§lbrack[]octal§rbrack[]}] §textbf[from] §textbf[file]
                         §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[IUU]          §textbf[31]   §textbf[Illegal] §textbf[user] §textbf[UUO] §textbf[at] §textbf[PC] §textbf[§lbrack[]octal§rbrack[]]
       ...
       §textbf[IVC]     §textbf[31]   §textbf[31]   §textbf[Index] §textbf[validation] §textbf[check] §textbf[failed] §textbf[at] §textbf[address] §textbf[§lbrack[]octal§rbrack[]]
       ...
       §textbf[JPB]      §textbf[8]    §textbf[8]   §textbf[Junk] §textbf[at] §textbf[end] §textbf[of] §textbf[Polish] §textbf[block]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[LDS]      §textbf[1]    §textbf[1]   §textbf[LOAD] §textbf[segment]

                         The  LINK  module  LNKLOD   is   beginning   its
                         processing.

       §textbf[LFB]      §textbf[1]    §textbf[1]   §textbf[LINK] §textbf[log] §textbf[file] §textbf[begun] §textbf[on] §textbf[§lbrack[]date§rbrack[]]
...

       ...
       §textbf[LFC]      §textbf[1]    §textbf[1]   §textbf[Log] §textbf[file] §textbf[continuation]

                         LINK is continuing your log file as a result  of
                         the /LOG switch.

       §textbf[LFI]      §textbf[1]    §textbf[1]   §textbf[Log] §textbf[file] §textbf[initialization]

                         LINK is beginning your log file as a  result  of
                         the /LOG switch.

       §textbf[LII]      §textbf[8]    §textbf[1]   §textbf[Library] §textbf[index] §textbf[inconsistent,] §textbf[continuing]
       ...
       §textbf[LIN]      §textbf[1]    §textbf[1]   §textbf[LINK] §textbf[initialization]

                         LINK is beginning its processing by initializing
                         its internal tables and variables.

       §textbf[LMM]     §textbf[+]    §textbf[+]    §textbf[Length] §textbf[mismatch] §textbf[for] §textbf[argument] §textbf[§lbrack[]decimal§rbrack[]]  §textbf[in]  §textbf[call]
                         §textbf[to]  §textbf[routine] §textbf[§lbrack[]symbol§rbrack[]] §textbf[called] §textbf[from] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[at] §textbf[location] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §lbrack[]2§rbrack[]
       ...
       §textbf[LMN]      §textbf[6]    §textbf[1]   §textbf[Loading] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]

                         LINK is loading the named module.

       §textbf[LNA]      §textbf[8]    §textbf[8]   §textbf[Link] §textbf[name] §textbf[§lbrack[]name§rbrack[]] §textbf[already] §textbf[assigned] §textbf[to] §textbf[link] §textbf[number]
                         §textbf[§lbrack[]decimal§rbrack[]]

                         You used this name for another link.  Specify  a
                         different name for this link.

       §textbf[LNL]      §textbf[8]    §textbf[8]   §textbf[Link] §textbf[number] §textbf[§lbrack[]decimal§rbrack[]] §textbf[not] §textbf[loaded]

   ---------------

    §lbrack[]2§rbrack[]  + The level and severity of this  message  is  determined  by  a
         compiler-generated  coercion  block.  A coercion block specifies
         which data type associations are  permissible  and  what  action
         LINK  should  take  if an illegal type association is attempted.
         See Block Type 1130 in Appendix A for more information.
...

       ...
       §textbf[LNM]     §textbf[31]   §textbf[31]   §textbf[Link] §textbf[number] §textbf[§lbrack[]decimal§rbrack[]] §textbf[not] §textbf[in] §textbf[memory]
       ...
       §textbf[LNN]      §textbf[8]    §textbf[8]   §textbf[Link] §textbf[name] §textbf[§lbrack[]name§rbrack[]] §textbf[not] §textbf[assigned]

                         The name you gave with the /NODE switch  is  not
                         the  name  of  any  loaded  link.  The switch is
                         ignored.

       §textbf[LNS]     §textbf[31]    §textbf[8]   §textbf[Low] §textbf[segment] §textbf[data] §textbf[base] §textbf[not] §textbf[same] §textbf[size]
       ...
       §textbf[LSM]      §textbf[8]    §textbf[8]   §textbf[/LINK] §textbf[switch] §textbf[missing] §textbf[while] §textbf[loading]  §textbf[link]  §textbf[number]
                         §textbf[§lbrack[]decimal§rbrack[]] §textbf[--] §textbf[assumed]
       ...
       §textbf[LSS]     §textbf[31]    §textbf[1]   §textbf[{No}]  §textbf[Library]  §textbf[search]  §textbf[symbols]  §textbf[(entry]   §textbf[points)]
                         §textbf[{§lbrack[]symbol§rbrack[]] §textbf[§lbrack[]octal§rbrack[]]

                         The listed symbols and their values (if any) are
                         those that are library search entry points.

       §textbf[MDS]      §textbf[8]    §textbf[8]   §textbf[Multiply-defined] §textbf[global] §textbf[symbol] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
                         §textbf[Defined] §textbf[value] §textbf[=] §textbf[§lbrack[]octal§rbrack[],] §textbf[this] §textbf[value] §textbf[=] §textbf[§lbrack[]octal§rbrack[]]
...

       ...
       §textbf[MEF]     §textbf[31]   §textbf[31]   §textbf[Memory] §textbf[expansion] §textbf[failed]
       ...
       §textbf[MMF]     §textbf[31]   §textbf[31]   §textbf[Memory] §textbf[manager] §textbf[failure]
       ...
       §textbf[MOV]      §textbf[1]    §textbf[1]   §textbf[Moving] §textbf[low] §textbf[segment] §textbf[to] §textbf[expand] §textbf[area] §textbf[§lbrack[]area§rbrack[]]
       ...
       §textbf[MPS]      §textbf[1]    §textbf[1]   §textbf[MAP] §textbf[segment]

                         The LINK module LNKMAP is writing a map file.

       §textbf[MPT]     §textbf[31]   §textbf[31]   §textbf[Mixed] §textbf[PSECT] §textbf[and] §textbf[TWOSEG] §textbf[code] §textbf[in] §textbf[same] §textbf[module]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[MRN]      §textbf[1]    §textbf[1]   §textbf[Multiple] §textbf[regions] §textbf[not] §textbf[yet] §textbf[implemented]
...

       ...
       §textbf[MSN]      §textbf[8]    §textbf[8]   §textbf[Map] §textbf[sorting] §textbf[not] §textbf[yet] §textbf[implemented]
       ...
       §textbf[NAP]     §textbf[31]   §textbf[31]   §textbf[No] §textbf[store] §textbf[address] §textbf[in] §textbf[polish]  §textbf[block]  §textbf[(type]  §textbf[11]  §textbf[or]
                         §textbf[1072)]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[NBR]     §textbf[31]   §textbf[31]   §textbf[Attempt] §textbf[to] §textbf[position] §textbf[to] §textbf[node] §textbf[before] §textbf[the] §textbf[root]
       ...
       §textbf[NEB]      §textbf[8]    §textbf[8]   §textbf[No] §textbf[end] §textbf[block] §textbf[seen]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[NED]     §textbf[31]   §textbf[24]   §textbf[Non-existent] §textbf[device] §textbf[§lbrack[]device§rbrack[]]

                         You gave a device that does not  exist  on  this
                         system.  Correct your input files and reload.

       §textbf[NFS]     §textbf[31]   §textbf[28]   §textbf[No] §textbf[free] §textbf[section] §textbf[for] §textbf[XDDT]
...

       ...
       §textbf[NHN]     §textbf[31]   §textbf[31]   §textbf[No] §textbf[high] §textbf[segment] §textbf[in] §textbf[nonzero] §textbf[section]
       ...
       §textbf[NPS]      §textbf[8]    §textbf[8]   §textbf[Non-existent] §textbf[PSECT] §textbf[§lbrack[]symbol§rbrack[]] §textbf[specified] §textbf[for] §textbf[symbol]
                         §textbf[table]
       ...
       §textbf[NSA]     §textbf[31]    §textbf[1]   §textbf[No] §textbf[start] §textbf[address]
       ...
       §textbf[NSM]     §textbf[31]   §textbf[31]   §textbf[/NODE] §textbf[switch] §textbf[missing] §textbf[after] §textbf[/LINK] §textbf[switch]
       ...
       §textbf[NSO]     §textbf[31]   §textbf[31]   §textbf[No] §textbf[store] §textbf[operator] §textbf[in] §textbf[Polish] §textbf[block] §textbf[(type] §textbf[11)]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[NVR]     §textbf[+]    §textbf[+]    §textbf[No] §textbf[value] §textbf[returned]  §textbf[by]  §textbf[routine]  §textbf[§lbrack[]symbol§rbrack[]]  §textbf[called]
                         §textbf[from] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[at] §textbf[location] §textbf[§lbrack[]octal§rbrack[]]
...

   ...
   §lbrack[]3§rbrack[]
       ...
       §textbf[OAS]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[writing] §textbf[area] §textbf[AS] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An error occurred while writing  out  the  ALGOL
                         symbol table.

       §textbf[OEL]      §textbf[8]    §textbf[8]   §textbf[Output] §textbf[error] §textbf[on]  §textbf[log]  §textbf[file,]  §textbf[file]  §textbf[closed,]  §textbf[load]
                         §textbf[continuing] §textbf[{§lbrack[]file§rbrack[]}]

                         An error has occurred on the output  file.   The
                         output  file  is  closed  at the end of the last
                         data successfully output.

       §textbf[OEM]      §textbf[8]    §textbf[8]   §textbf[Output] §textbf[error] §textbf[on]  §textbf[map]  §textbf[file,]  §textbf[file]  §textbf[closed,]  §textbf[load]
                         §textbf[continuing] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[OES]      §textbf[8]    §textbf[8]   §textbf[Output] §textbf[error] §textbf[on] §textbf[symbol] §textbf[file,] §textbf[file]  §textbf[closed,]  §textbf[load]
                         §textbf[continuing] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[OFD]     §textbf[31]   §textbf[31]   §textbf[OPEN] §textbf[failure] §textbf[for] §textbf[device] §textbf[§lbrack[]device§rbrack[]]

                         An OPEN or INIT monitor call for  the  specified
                         device  failed.  The device may be under another
                         user's control.>

       §textbf[OFN]     §textbf[31]   §textbf[31]   §textbf[Old] §textbf[FORTRAN] §textbf[(F40)] §textbf[module] §textbf[not] §textbf[available]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]

                         The standard released version of LINK  does  not
                         support F40 code.

       §textbf[OFS]     §textbf[31]   §textbf[31]   §textbf[Overlay] §textbf[file] §textbf[must] §textbf[be] §textbf[created] §textbf[on] §textbf[a] §textbf[file] §textbf[structure]

   ---------------

    §lbrack[]3§rbrack[]  + The level and severity of this  message  is  determined  by  a
         compiler-generated  coercion  block.  A coercion block specifies
         which data type associations are  permissible  and  what  action
         LINK  should  take  if an illegal type association is attempted.
         See Block Type 1130 in Appendix A for more information.
...

       ...
       §textbf[OHC]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[writing] §textbf[area] §textbf[HC]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An  error  occurred  while  writing   out   your
                         high-segment code.

       §textbf[OHN]     §textbf[31]   §textbf[31]   §textbf[Overlay] §textbf[handler] §textbf[not] §textbf[loaded]
       ...
       §textbf[OLC]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[writing] §textbf[area] §textbf[LC]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An  error  occurred  while  writing   out   your
                         low-segment code.

       §textbf[OLS]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[writing] §textbf[area] §textbf[LS] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]

                         An error occurred while writing out  your  local
                         symbol table.

       §textbf[OMB]     §textbf[31]   §textbf[31]   §textbf[/OVERLAY] §textbf[switch] §textbf[must] §textbf[be] §textbf[first]
       ...
       §textbf[ONS]      §textbf[8]    §textbf[1]   §textbf[Overlays] §textbf[not] §textbf[supported] §textbf[in] §textbf[this] §textbf[version] §textbf[of] §textbf[LINK]
       ...
       §textbf[OOV]     §textbf[31]   §textbf[31]   §textbf[Output] §textbf[error] §textbf[for] §textbf[overlay] §textbf[file] §textbf[§lbrack[]file§rbrack[]]

                         An error has occurred while writing the  overlay
                         file.

       §textbf[OS2]      §textbf[1]    §textbf[1]   §textbf[Overlay] §textbf[segment] §textbf[phase] §textbf[2]
...

       ...
       §textbf[OSL]      §textbf[8]    §textbf[8]   §textbf[Overlaid] §textbf[program] §textbf[symbols] §textbf[must] §textbf[be] §textbf[in] §textbf[low] §textbf[segment]

                         You have specified /SYMSEG:HIGH or /SYMSEG:PSECT
                         when  loading  an  overlay  structure.   Specify
                         /SYMSEG:LOW or /SYMSEG:DEFAULT.

       §textbf[OTP]     §textbf[31]   §textbf[31]   §textbf[Error] §textbf[writing] §textbf[area] §textbf[TP] §textbf[{Status] §textbf[§lbrack[]octal§rbrack[]}] §textbf[from] §textbf[file]
                         §textbf[§lbrack[]file§rbrack[]]
                         §textbf[{JSYS] §textbf[error] §textbf[text}]
       ...
       §textbf[PAS]      §textbf[1]    §textbf[1]   §textbf[Area] §textbf[AS] §textbf[overflowing] §textbf[to] §textbf[disk]

                         The load is too large to fit  into  the  allowed
                         memory and the ALGOL symbol table is being moved
                         to disk.

       §textbf[PBI]      §textbf[8]    §textbf[8]   §textbf[Program]  §textbf[break]  §textbf[§lbrack[]octal§rbrack[]]  §textbf[invalid]  §textbf[{Detected]   §textbf[in]
                         §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[PCL]      §textbf[8]    §textbf[8]   §textbf[Program] §textbf[too] §textbf[complex]  §textbf[to]  §textbf[load,]  §textbf[saving]  §textbf[as]  §textbf[file]
                         §textbf[§lbrack[]file§rbrack[]]
...

       ...
       §textbf[PCX]      §textbf[8]    §textbf[1]   §textbf[Program] §textbf[too] §textbf[complex] §textbf[to] §textbf[load]  §textbf[and]  §textbf[execute,]  §textbf[will]
                         §textbf[run] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[PEF]     §textbf[31]    §textbf[8]   §textbf[Premature] §textbf[end] §textbf[of] §textbf[file] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]
       ...
       §textbf[PEL]     §textbf[31]    §textbf[8]   §textbf[PSECT] §textbf[§lbrack[]symbol§rbrack[]] §textbf[exceeded] §textbf[limit] §textbf[of] §textbf[§lbrack[]octal§rbrack[]]
       ...
       §textbf[PHC]      §textbf[1]    §textbf[1]   §textbf[Area] §textbf[HC] §textbf[overflowing] §textbf[to] §textbf[disk]

                         The load is too large to fit  into  the  allowed
                         memory and your high-segment code is being moved
                         to disk.

       §textbf[PLC]      §textbf[1]    §textbf[1]   §textbf[Area] §textbf[LC] §textbf[overflowing] §textbf[to] §textbf[disk]
...

       ...
       §textbf[PLS]      §textbf[1]    §textbf[1]   §textbf[Area] §textbf[LS] §textbf[overflowing] §textbf[to] §textbf[disk]

                         The load is too large to fit  into  the  allowed
                         memory  and  your  local symbol tables are being
                         moved to disk.

       §textbf[PMA]     §textbf[+]    §textbf[+]    §textbf[Possible] §textbf[modification] §textbf[of] §textbf[argument]  §textbf[§lbrack[]decimal§rbrack[]]  §textbf[in]
                         §textbf[call]  §textbf[to]  §textbf[routine]  §textbf[§lbrack[]symbol§rbrack[]]  §textbf[called]  §textbf[from] §textbf[module]
                         §textbf[§lbrack[]symbol§rbrack[]] §textbf[at] §textbf[location] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §lbrack[]4§rbrack[]
       ...
       §textbf[PNO]      §textbf[8]    §textbf[8]   §textbf[Program] §textbf[Data]  §textbf[Vectors]  §textbf[not]  §textbf[allowed]  §textbf[in]  §textbf[overlay]
                         §textbf[links]
       ...
       §textbf[POT]      §textbf[1]    §textbf[1]   §textbf[Plotting] §textbf[overlay] §textbf[tree]

                         LINK is creating your overlay tree file.

       §textbf[POV]      §textbf[8]    §textbf[8]   §textbf[PSECTs]  §textbf[§lbrack[]symbol§rbrack[]]  §textbf[and]  §textbf[§lbrack[]symbol§rbrack[]]   §textbf[overlap]   §textbf[from]
                         §textbf[address] §textbf[§lbrack[]octal§rbrack[]] §textbf[to] §textbf[§lbrack[]octal§rbrack[]]
       ...
       §textbf[PTL]     §textbf[31]   §textbf[31]   §textbf[Program] §textbf[too] §textbf[long]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
   ...
   ---------------
    ...
    §lbrack[]4§rbrack[]  + The level and severity of this  message  is  determined  by  a
         compiler-generated  coercion  block.  A coercion block specifies
         which data type associations are  permissible  and  what  action
         LINK  should  take  if an illegal type association is attempted.
         See Block Type 1130 in Appendix A for more information.
...

       ...
       §textbf[RBS]     §textbf[31]   §textbf[31]   §textbf[REL] §textbf[block] §textbf[type] §textbf[§lbrack[]octal§rbrack[]] §textbf[too] §textbf[short]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[RED]      §textbf[1]    §textbf[1]   §textbf[Reducing] §textbf[low] §textbf[segment] §textbf[to] §textbf[§lbrack[]memory§rbrack[]]

                         LINK  is  reclaiming  memory  by  deleting   its
                         internal tables.

       §textbf[RER]      §textbf[*]    §textbf[1]   §textbf[{No}]  §textbf[Request]  §textbf[external]  §textbf[references]  §textbf[(inter-link]
                         §textbf[entry] §textbf[points)]
                         §textbf[{§lbrack[]symbol§rbrack[]] §textbf[§lbrack[]octal§rbrack[]}]
       ...
       §textbf[RGS]      §textbf[1]    §textbf[1]   §textbf[Rehashing] §textbf[global] §textbf[symbol] §textbf[table] §textbf[from] §textbf[§lbrack[]decimal§rbrack[]]  §textbf[to]
                         §textbf[§lbrack[]decimal§rbrack[]]
       ...
       §textbf[RLC]     §textbf[31]    §textbf[1]   §textbf[Reloc] §textbf[ctr.]  §textbf[initial] §textbf[value] §textbf[current] §textbf[value]
                         §textbf[{§lbrack[]symbol§rbrack[]] §textbf[§lbrack[]octal§rbrack[]] §textbf[§lbrack[]octal§rbrack[]}]

                         The listed  symbols  and  values  represent  the
                         current  placement  of  PSECTs  in  your address
                         space.

       §textbf[RUM]     §textbf[31]   §textbf[31]   §textbf[Returning] §textbf[unavailable] §textbf[memory]
...

       ...
       §textbf[RWA]     §textbf[8]    §textbf[8]    §textbf[Both]   §textbf[READ-ONLY]   §textbf[and]   §textbf[WRITEABLE]    §textbf[attributes]
                         §textbf[specified] §textbf[for] §textbf[psect] §textbf[§lbrack[]] §textbf[name] §textbf[§rbrack[]]
       ...
       §textbf[SFU]      §textbf[8]    §textbf[8]   §textbf[Symbol] §textbf[table] §textbf[fouled] §textbf[up]
       ...
       §textbf[SIF]     §textbf[31]   §textbf[31]   §textbf[Symbol] §textbf[insert] §textbf[failure,] §textbf[non-zero] §textbf[hole] §textbf[found]
       ...
       §textbf[SMP]      §textbf[8]    §textbf[8]   §textbf[SIMULA] §textbf[main] §textbf[program] §textbf[not] §textbf[loaded]
       ...
       §textbf[SNC]     §textbf[31]   §textbf[31]   §textbf[Symbol] §textbf[§lbrack[]symbol§rbrack[]]  §textbf[already]  §textbf[defined,]  §textbf[but]  §textbf[not]  §textbf[as]
                         §textbf[common]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[SNL]      §textbf[1]    §textbf[1]   §textbf[Scanning] §textbf[new] §textbf[command] §textbf[line]

                         LINK is ready to process the next command line.

       §textbf[SNP]      §textbf[8]    §textbf[8]   §textbf[Subroutine] §textbf[§lbrack[]symbol§rbrack[]] §textbf[in] §textbf[link] §textbf[number] §textbf[§lbrack[]decimal§rbrack[]] §textbf[not]
...

                         ...
                         §textbf[on]  §textbf[path]  §textbf[for]  §textbf[call]  §textbf[from]  §textbf[link] §textbf[number] §textbf[§lbrack[]decimal§rbrack[]]
                         §textbf[{name] §textbf[§lbrack[]name§rbrack[]}]
       ...
       §textbf[SNS]     §textbf[31]   §textbf[31]   §textbf[SITGO] §textbf[not] §textbf[supported]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[SOE]     §textbf[31]   §textbf[31]   §textbf[Saved] §textbf[file] §textbf[output] §textbf[error] §textbf[§lbrack[]file§rbrack[]]

                         An error occurred in outputting the EXE file.

       §textbf[SPF]     §textbf[31]   §textbf[8]    §textbf[Splice] §textbf[fork] §textbf[failed] §textbf[{,saving] §textbf[on] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[SRB]      §textbf[8]    §textbf[8]   §textbf[Attempt] §textbf[to] §textbf[set] §textbf[relocation] §textbf[counter] §textbf[§lbrack[]symbol§rbrack[]] §textbf[below]
                         §textbf[initial] §textbf[value] §textbf[of] §textbf[§lbrack[]octal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[SRP]     §textbf[31]   §textbf[31]   §textbf[/SET:]  §textbf[switch] §textbf[required] §textbf[for] §textbf[PSECT] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[SSN]      §textbf[8]    §textbf[8]   §textbf[Symbol] §textbf[table] §textbf[sorting] §textbf[not] §textbf[yet] §textbf[implemented]

                         Alphabetical or numerical sorting of the  symbol
                         table is not implemented.  The symbols appear in
                         the order they are found.

       §textbf[SST]      §textbf[1]    §textbf[1]   §textbf[Sorting] §textbf[symbol] §textbf[table]
...

       ...
       §textbf[STC]      §textbf[1]    §textbf[1]   §textbf[Symbol] §textbf[table] §textbf[completed]

                         The symbol  table  has  been  sorted  and  moved
                         according  to  the  /SYMSEG,  /SYFILE, or /DEBUG
                         switch.

       §textbf[STL]     §textbf[31]   §textbf[31]   §textbf[Symbol] §textbf[too] §textbf[long]

                         A symbol specified in a rel block is longer than
                         the maximum allowed by LINK.

       §textbf[SUP]      §textbf[1]    §textbf[1]   §textbf[Loading] §textbf[suppressed]
       ...
       §textbf[T13]     §textbf[31]   §textbf[31]   §textbf[LVAR] §textbf[REL] §textbf[block] §textbf[(type] §textbf[13)] §textbf[not] §textbf[implemented]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]

                         REL Block Type 13 (LVAR) is obsolete.   Use  the
                         MACRO pseudo-op TWOSEG.

       §textbf[TDS]      §textbf[8]    §textbf[8]   §textbf[Too] §textbf[late] §textbf[to] §textbf[delete] §textbf[initial] §textbf[symbols]
       ...
       §textbf[TMA]     §textbf[31]    §textbf[8]   §textbf[Too] §textbf[many] §textbf[ambiguous] §textbf[requests]  §textbf[in]  §textbf[link]  §textbf[§lbrack[]decimal§rbrack[]]
                         §textbf[{name] §textbf[§lbrack[]name§rbrack[]},] §textbf[use] §textbf[/ARSIZE:§lbrack[]decimal§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[TML]     §textbf[31]   §textbf[31]   §textbf[Too] §textbf[many] §textbf[links,] §textbf[use] §textbf[/MAXNODE]
...

       ...
       §textbf[TMM]     §textbf[+]    §textbf[+]    §textbf[Type] §textbf[mismatch] §textbf[seen]  §textbf[for]  §textbf[argument]  §textbf[§lbrack[]decimal§rbrack[]]  §textbf[in]
                         §textbf[call]  §textbf[to]  §textbf[routine]  §textbf[§lbrack[]symbol§rbrack[]]  §textbf[called]  §textbf[from] §textbf[module]
                         §textbf[§lbrack[]symbol§rbrack[]] §textbf[at] §textbf[location] §textbf[§lbrack[]octal§rbrack[]]
   ...
   §lbrack[]5§rbrack[]
       ...
       §textbf[TTF]      §textbf[8]    §textbf[8]   §textbf[Too] §textbf[many] §textbf[titles] §textbf[found]
       ...
       §textbf[UAR]      §textbf[8]    §textbf[8]   §textbf[Undefined] §textbf[assign] §textbf[for] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[UCB]     §textbf[8]    §textbf[8]    §textbf[Unknown] §textbf[COMMON] §textbf[§lbrack[]symbol§rbrack[]] §textbf[referenced]

                         A reference was made to a common block,  however
                         the block does not exist.

       §textbf[UIE]     §textbf[31]   §textbf[31]   §textbf[Unexpected] §textbf[internal] §textbf[error] §textbf[during] §textbf[processing]
   ...
   ---------------
    ...
    §lbrack[]5§rbrack[]  + The level and severity of this  message  is  determined  by  a
         compiler-generated  coercion  block.  A coercion block specifies
         which data type associations are  permissible  and  what  action
         LINK  should  take  if an illegal type association is attempted.
         See Block Type 1130 in Appendix A for more information.
...

       ...
       §textbf[UGS]      §textbf[*]    §textbf[1]   §textbf[{No}] §textbf[Undefined] §textbf[global] §textbf[symbols] §textbf[{§lbrack[]symbol§rbrack[]] §textbf[§lbrack[]octal§rbrack[]]
       ...
       UMF     31   31   Unexpected monitor call failure for §lbrack[]JSYS§rbrack[] at PC
                         §lbrack[]octal§rbrack[]
                         {JSYS error text}
       ...
       §textbf[UNS]     §textbf[31]   §textbf[31]   §textbf[Universal]  §textbf[file]  §textbf[REL]  §textbf[block]   §textbf[(type]   §textbf[777)]   §textbf[not]
                         §textbf[supported] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]]

                         Extraction of symbols  from  a  MACRO  universal
                         file is not implemented.

       §textbf[URC]     §textbf[31]    §textbf[1]   §textbf[Unknown] §textbf[Radix-50] §textbf[symbol] §textbf[code] §textbf[§lbrack[]octal§rbrack[]] §textbf[§lbrack[]symbol§rbrack[]]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[URV]     §textbf[+]    §textbf[+]    §textbf[Unexpected]  §textbf[return]  §textbf[value]  §textbf[in]  §textbf[call]  §textbf[to]  §textbf[routine]
                         §textbf[§lbrack[]symbol§rbrack[]] §textbf[called] §textbf[from] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[at] §textbf[location]
                         §textbf[§lbrack[]octal§rbrack[]]
   ...
   §lbrack[]6§rbrack[]
       ...
       §textbf[USA]      §textbf[8]    §textbf[8]   §textbf[Undefined] §textbf[start] §textbf[address] §textbf[§lbrack[]symbol§rbrack[]]
...

       ...
       §textbf[USB]     §textbf[8]    §textbf[8]    §textbf[Undefined] §textbf[symbol] §textbf[in] §textbf[byte] §textbf[array] §textbf[(type] §textbf[1004)] §textbf[block]
                         §textbf[{Detected] §textbf[in] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[from] §textbf[file] §textbf[§lbrack[]file§rbrack[]}]
       ...
       §textbf[USC]     §textbf[31]    §textbf[8]   §textbf[Undefined] §textbf[subroutine] §textbf[§lbrack[]symbol§rbrack[]] §textbf[called]  §textbf[from]  §textbf[link]
                         §textbf[number] §textbf[§lbrack[]decimal§rbrack[]] §textbf[{name] §textbf[§lbrack[]name§rbrack[]}]
       ...
       §textbf[USD]     §textbf[31]   §textbf[31]   §textbf[Undefined] §textbf[symbol] §textbf[§lbrack[]] §textbf[symbol] §textbf[§rbrack[]] §textbf[used] §textbf[in] §textbf[loading] §textbf[code]
                         §textbf[or] §textbf[data] §textbf[blocks]
       ...
       §textbf[USI]      §textbf[8]   §textbf[16]   §textbf[Undefined]  §textbf[symbol]  §textbf[§lbrack[]symbol§rbrack[]]  §textbf[illegal]  §textbf[in]  §textbf[switch]
                         §textbf[§lbrack[]switch§rbrack[]]
       ...
       §textbf[UUA]      §textbf[8]    §textbf[8]   §textbf[Undefined] §textbf[/UPTO:]  §textbf[address] §textbf[§lbrack[]symbol§rbrack[]]
       ...
       §textbf[VAL]     §textbf[31]    §textbf[1]   §textbf[Symbol] §textbf[§lbrack[]symbol§rbrack[]] §textbf[§lbrack[]octal§rbrack[]] §textbf[§lbrack[]type§rbrack[]]

                         LINK has printed the specified symbol, its value
                         and its attributes as requested.
   ---------------

    §lbrack[]6§rbrack[]  + The level and severity of this  message  is  determined  by  a
         compiler-generated  coercion  block.  A coercion block specifies
         which data type associations are  permissible  and  what  action
         LINK  should  take  if an illegal type association is attempted.
         See Block Type 1130 in Appendix A for more information.
...

       ...
       §textbf[WNA]     §textbf[+]    §textbf[+]    §textbf[Wrong] §textbf[number] §textbf[of] §textbf[arguments]  §textbf[in]  §textbf[call]  §textbf[to]  §textbf[routine]
                         §textbf[§lbrack[]symbol§rbrack[]] §textbf[called] §textbf[from] §textbf[module] §textbf[§lbrack[]symbol§rbrack[]] §textbf[at] §textbf[location]
                         §textbf[§lbrack[]octal§rbrack[]]
       ...
       §textbf[XCT]     §textbf[31]    §textbf[1]   §textbf[§lbrack[]Name§rbrack[]] §textbf[execution]

                         LINK is beginning execution of your program.

       §textbf[ZSV]      §textbf[8]    §textbf[8]   §textbf[Zero] §textbf[switch] §textbf[value] §textbf[illegal]
   ...
   §textbf[B.3]  §textbf[REASON] §textbf[EXPLANATION]

   The §lbrack[]reason§rbrack[] message segment of the LNKEOV,  LNKETP,  LNKFEE,  LNKFLE,
   and LNKFRE messages may contain one of the following codes.


       §textbf[Code]            §textbf[Description]
...

                                 ...
                                 §textbf[APPENDIX] §textbf[C]

                    §textbf[JOB] §textbf[DATA] §textbf[AREA] §textbf[LOCATIONS] §textbf[SET] §textbf[BY] §textbf[LINK]
   ...
   §textbf[C.1]  §textbf[JOB] §textbf[DATA] §textbf[AREA]


   §textbf[Address]   §textbf[Symbolic]            §textbf[Use]
...

   ...
   §textbf[Address]   §textbf[Symbolic]            §textbf[Use]
      ...
      137    .JBVER    Version   Program version  number  (in octal)  and
                       number:   flags, in the format shown below.
                                 ...
                                 §textbf[Bits]   §textbf[Meaning]

                                  0-2   Modifier flag:

                                        §textbf[Flag]  §textbf[Meaning]
   ...
   §textbf[C.1.1]  §textbf[Vestigial] §textbf[Job] §textbf[Data] §textbf[Area]

     §textbf[Offset]  §textbf[Symbolic]            §textbf[Use]
